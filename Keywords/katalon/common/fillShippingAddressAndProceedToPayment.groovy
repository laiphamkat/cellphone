...
public class fillShippingAddressAndProceedToPayment {
    ...
    private static def execute_functional_method(Map data) {
        ...
        WebUI.setText(findTestObject('AI-Generated/Page_checkout/input_firstName'), data['var_1_input_firstName'])
        ...
        WebUI.setText(findTestObject('AI-Generated/Page_checkout/input_lastName'), data['var_2_input_lastName'])
        ...
        WebUI.setText(findTestObject('AI-Generated/Page_checkout/input_address'), data['var_3_input_address'])
        ...
        WebUI.setText(findTestObject('AI-Generated/Page_checkout/input_zipcode'), data['var_4_input_zipcode'])
        ...
        WebUI.setText(findTestObject('AI-Generated/Page_checkout/input_city'), data['var_5_input_city'])
