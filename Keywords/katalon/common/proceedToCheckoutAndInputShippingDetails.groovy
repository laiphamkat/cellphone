...
public class proceedToCheckoutAndInputShippingDetails {
    ...
    private static def execute_functional_method(Map data) {
        ...
        //WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)
        WebUI.setText(findTestObject('AI-Generated/Page_checkout_shipping_address/input_state_1'), data['input_shipping_address_state'])
        WebUI.takeScreenshot()
        ...
        //WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)
        WebUI.setText(findTestObject('AI-Generated/Page_checkout_shipping_address/input_phone_1'), data['input_shipping_address_phone'])
        WebUI.takeScreenshot()
        "Step 27: Click on button 'CONTINUE TO PAYMENT'"
        //WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)
