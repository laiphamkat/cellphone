...
public class browsePhoneCategorySetPriceRangeSearch {
    ...
    private static def execute_functional_method(Map data) {
        ...
        WebUI.setText(findTestObject('AI-Generated/Page_category_phone/input_price_min'), data['fn2_input_price_min'])
        ...
        WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/category/phone?/?(?:#.*)?(?:\\?.*)?$', true)
        WebUI.setText(findTestObject('AI-Generated/Page_category_phone/input_price_max'), data['fn2_input_price_max'])
    ...
    private static def execute_with_data_source(String datasource, int rowIndex) {
        ...
        Map data = [:]
        data['fn2_input_price_min'] = testData.getValue('fn2_input_price_min', rowIndex)
        data['fn2_input_price_max'] = testData.getValue('fn2_input_price_max', rowIndex)
        execute_functional_method(data)
    }
    
    private static def execute_without_data_source() {
        Map data = [:]
        data['fn2_input_price_min'] = 'default_data'
        data['fn2_input_price_max'] = 'default_data'
        execute_functional_method(data)
    }
