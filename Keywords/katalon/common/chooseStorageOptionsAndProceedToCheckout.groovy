...
public class chooseStorageOptionsAndProceedToCheckout {
    ...
    private static def execute_functional_method(Map data) {
        ...
        WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_product/label_storageColorOptions_3', ['label_storageColorOptions_for': data['label_storageColorOptions_for'], 'label_storageColorOptions_internalText': data['label_storageColorOptions_internalText']]))
        ...
        WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_cart/button_quantityAdjustment', ['button_quantityAdjustment_class': data['button_quantityAdjustment_class'], 'button_quantityAdjustment_nthChild': data['button_quantityAdjustment_nthChild'], 'button_quantityAdjustment_internalRoleButtonName': data['button_quantityAdjustment_internalRoleButtonName']]))
