...
public class proceedToCheckoutFillShippingAddressDetailsAndContinueToPayment {
    ...
    private static def execute_functional_method(Map data) {
        ...
        WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_checkout_info/input_email'), 20, FailureHandling.CONTINUE_ON_FAILURE)
        WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/checkout/info?/?(?:#.*)?(?:\\?.*)?$', true)
        WebUI.setText(findTestObject('AI-Generated/Page_checkout_info/input_email'), data['fn1_input_email'])
        ...
        WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_checkout_shipping_address/input_shipping_addressfirst_name'), 20, FailureHandling.CONTINUE_ON_FAILURE)
        WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)
        WebUI.setText(findTestObject('AI-Generated/Page_checkout_shipping_address/input_shipping_addressfirst_name'), data['fn1_input_shipping_addressfirst_name'])
        ...
        WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_checkout_shipping_address/input_shipping_addresslast_name'), 20, FailureHandling.CONTINUE_ON_FAILURE)
        WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)
        WebUI.setText(findTestObject('AI-Generated/Page_checkout_shipping_address/input_shipping_addresslast_name'), data['fn1_input_shipping_addresslast_name'])
        ...
        WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_checkout_shipping_address/input_shipping_addressaddress_line_1'), 20, FailureHandling.CONTINUE_ON_FAILURE)
        WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)
        WebUI.setText(findTestObject('AI-Generated/Page_checkout_shipping_address/input_shipping_addressaddress_line_1'), data['fn1_input_shipping_addressaddress_line_1'])
        ...
        WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_checkout_shipping_address/input_shipping_addresszip'), 20, FailureHandling.CONTINUE_ON_FAILURE)
        WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)
        WebUI.setText(findTestObject('AI-Generated/Page_checkout_shipping_address/input_shipping_addresszip'), data['fn1_input_shipping_addresszip'])
        ...
        WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_checkout_shipping_address/input_shipping_addresscity'), 20, FailureHandling.CONTINUE_ON_FAILURE)
        WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)
        WebUI.setText(findTestObject('AI-Generated/Page_checkout_shipping_address/input_shipping_addresscity'), data['fn1_input_shipping_addresscity'])
        ...
        WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_checkout_shipping_address/input_shipping_addressstate'), 20, FailureHandling.CONTINUE_ON_FAILURE)
        WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)
        WebUI.setText(findTestObject('AI-Generated/Page_checkout_shipping_address/input_shipping_addressstate'), data['fn1_input_shipping_addressstate'])
        ...
        WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_checkout_shipping_address/input_shipping_addressphone'), 20, FailureHandling.CONTINUE_ON_FAILURE)
        WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)
        WebUI.setText(findTestObject('AI-Generated/Page_checkout_shipping_address/input_shipping_addressphone'), data['fn1_input_shipping_addressphone'])
    ...
    private static def execute_with_data_source(String datasource, int rowIndex) {
        ...
        Map data = [:]
        data['fn1_input_email'] = testData.getValue('fn1_input_email', rowIndex)
        data['fn1_input_shipping_addressfirst_name'] = testData.getValue('fn1_input_shipping_addressfirst_name', rowIndex)
        data['fn1_input_shipping_addresslast_name'] = testData.getValue('fn1_input_shipping_addresslast_name', rowIndex)
        data['fn1_input_shipping_addressaddress_line_1'] = testData.getValue('fn1_input_shipping_addressaddress_line_1', rowIndex)
        data['fn1_input_shipping_addresszip'] = testData.getValue('fn1_input_shipping_addresszip', rowIndex)
        data['fn1_input_shipping_addresscity'] = testData.getValue('fn1_input_shipping_addresscity', rowIndex)
        data['fn1_input_shipping_addressstate'] = testData.getValue('fn1_input_shipping_addressstate', rowIndex)
        data['fn1_input_shipping_addressphone'] = testData.getValue('fn1_input_shipping_addressphone', rowIndex)
        execute_functional_method(data)
    }
    
    private static def execute_without_data_source() {
        Map data = [:]
        data['fn1_input_email'] = 'default_data'
        data['fn1_input_shipping_addressfirst_name'] = 'default_data'
        data['fn1_input_shipping_addresslast_name'] = 'default_data'
        data['fn1_input_shipping_addressaddress_line_1'] = 'default_data'
        data['fn1_input_shipping_addresszip'] = 'default_data'
        data['fn1_input_shipping_addresscity'] = 'default_data'
        data['fn1_input_shipping_addressstate'] = 'default_data'
        data['fn1_input_shipping_addressphone'] = 'default_data'
        execute_functional_method(data)
    }
