...
public class searchAccessoriesByPriceRange {
    ...
    private static def execute_functional_method(Map data) {
        ...
        WebUI.setText(findTestObject('AI-Generated/Page_category_accessories/input_price_min'), data['input_price_min'])
        ...
        WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/category/accessories?/?(?:#.*)?(?:\\?.*)?$', true)
        WebUI.setText(findTestObject('AI-Generated/Page_category_accessories/input_price_max'), data['input_price_max'])
