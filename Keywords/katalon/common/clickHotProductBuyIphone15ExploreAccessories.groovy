...
public class clickHotProductBuyIphone15ExploreAccessories {
    ...
    private static def execute_functional_method(Map data) {
        ...
        "Step 2: Click on link ' Hot!' -> Navigate to page 'product/*'"
        WebUI.takeScreenshot()
        ...
        "Step 9: Click on link 'iPhone 15 Plus' -> Navigate to page 'product/*'"
        WebUI.takeScreenshot()
        ...
        "Step 13: Click on link 'Phone' -> Navigate to page 'category/phone'"
        WebUI.takeScreenshot()
        ...
        "Step 14: Click on link 'Apple' -> Navigate to page 'category/apple'"
        WebUI.takeScreenshot()
        ...
        "Step 15: Click on link 'iPhone 15' -> Navigate to page 'product/*'"
        WebUI.takeScreenshot()
        ...
        "Step 17: Click on link 'Accessories' -> Navigate to page 'category/accessories'"
        WebUI.takeScreenshot()
        ...
        "Step 18: Click on link 'Apple' -> Navigate to page 'category/chekhly-na-iphone'"
        WebUI.takeScreenshot()
        ...
        "Step 19: Click on link 'Apple' -> Navigate to page 'category/apple'"
        WebUI.takeScreenshot()
        WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_category_chekhly_na_iphone/hyperlink_apple'), 20, FailureHandling.CONTINUE_ON_FAILURE)
        WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/category/chekhly-na-iphone?/?(?:#.*)?(?:\\?.*)?$', true)
        WebUI.enhancedClick(findTestObject('AI-Generated/Page_category_chekhly_na_iphone/hyperlink_apple'))
        "Step 20: Click on link 'iPhone 15'"
        WebUI.takeScreenshot()
        WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_category_apple/hyperlink_iphone 15'), 20, FailureHandling.CONTINUE_ON_FAILURE)
        WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/category/apple?/?(?:#.*)?(?:\\?.*)?$', true)
        WebUI.enhancedClick(findTestObject('AI-Generated/Page_category_apple/hyperlink_iphone 15'))
