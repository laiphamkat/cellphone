...
public class searchPhonesByPriceRange {
    ...
    private static def execute_functional_method(Map data) {
        ...
        WebUI.setText(findTestObject('AI-Generated/Page_category_phone/input_price_min'), data['input_price_min'])
        ...
        WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/category/phone?/?(?:#.*)?(?:\\?.*)?$', true)
        WebUI.setText(findTestObject('AI-Generated/Page_category_phone/input_price_max'), data['input_price_max'])
