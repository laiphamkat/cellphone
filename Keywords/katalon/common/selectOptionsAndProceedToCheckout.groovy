...
public class selectOptionsAndProceedToCheckout {
    
    private static def execute_functional_method(Map data) {
        
        "Step 1: Click on label colorStorageOptions (512Gb)"
        
        // Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_product/label_colorStorageOptions"
        WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_product/label_colorStorageOptions', ['label_colorStorageOptions_for': data['label_colorStorageOptions_for'], 'label_colorStorageOptions_internalText': data['label_colorStorageOptions_internalText']]))
