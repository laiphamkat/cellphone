...
public class viewBrandProductDetailsAndPurchase {
    ...
    private static def execute_functional_method(Map data) {
        ...
        "Step 2: Click on link productDetails -> Navigate to page 'product#product/*'"
        
        // Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_category/link_productDetails"
        WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_category/link_productDetails', ['link_productDetails_class': data['link_productDetails_class'], 'link_productDetails_internalRoleLinkName': data['link_productDetails_internalRoleLinkName'], 'product_id': data['product_id']]))
    ...
    private static def execute_with_data_source(String datasource, int rowIndex) {
        ...
        data['link_productDetails_class'] = testData.getValue('link_productDetails_class', rowIndex)
        data['link_productDetails_internalRoleLinkName'] = testData.getValue('link_productDetails_internalRoleLinkName', rowIndex)
    ...
    private static def execute_without_data_source() {
        ...
        data['link_productDetails_class'] = 'default_data'
        data['link_productDetails_internalRoleLinkName'] = 'default_data'
