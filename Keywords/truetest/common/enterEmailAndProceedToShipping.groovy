...
public class enterEmailAndProceedToShipping {
    ...
    private static def execute_functional_method(Map data) {
        ...
        "Step 1: Click on button ProceedToCheckout -> Navigate to page 'form:/{fixed part}/{fixed page}'"
        
        WebUI.enhancedClick(findTestObject('AI-Generated/Page_display_list_of_items_fixed_page/button_ProceedToCheckout'))
        
        "Step 2: Hover over div MainContent"
        
        WebUI.mouseOver(findTestObject('AI-Generated/Page_form_fixed_part_fixed_page/div_MainContent_1'))
        ...
        WebUI.setText(findTestObject('AI-Generated/Page_form_fixed_part_fixed_page/input_Email'), data['input_Email'])
        ...
        "Step 6: Hover over div MainContent"
