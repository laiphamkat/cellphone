...
public class selectProductOptionsAndProceedToCheckout {
    ...
    private static def execute_functional_method(Map data) {
        ...
        "Step 2: Click on label storageColorOptions (Green2)"
        ...
        "Step 3: Click on button buy (Buy)"
        
        // Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_category/button_buy"
        WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_category/button_buy', ['button_buy_internalRoleButtonName': data['button_buy_internalRoleButtonName']]))
    ...
    private static def execute_with_data_source(String datasource, int rowIndex) {
        ...
        Map data = [:]
        data['button_buy_internalRoleButtonName'] = testData.getValue('button_buy_internalRoleButtonName', rowIndex)
    ...
    private static def execute_without_data_source() {
        Map data = [:]
        data['button_buy_internalRoleButtonName'] = 'default_data'
