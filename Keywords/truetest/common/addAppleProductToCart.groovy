...
public class addAppleProductToCart {
    ...
    private static def execute_functional_method(Map data) {
        ...
        "Step 3: Click on label storageColor"
        
        // Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_category/label_storageColor"
        WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_category/label_storageColor', ['label_storageColor_for': data['label_storageColor_for'], 'label_storageColor_internalText': data['label_storageColor_internalText']]))
        
        "Step 4: Click on label storageColor"
        
        // Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_category/label_storageColor"
        WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_category/label_storageColor', ['label_storageColor_for': data['label_storageColor_for_1'], 'label_storageColor_internalText': data['label_storageColor_internalText_1']]))
    ...
    private static def execute_with_data_source(String datasource, int rowIndex) {
        ...
        data['label_storageColor_for'] = testData.getValue('label_storageColor_for', rowIndex)
        data['label_storageColor_for_1'] = testData.getValue('label_storageColor_for_1', rowIndex)
    ...
    private static def execute_without_data_source() {
        ...
        data['label_storageColor_for'] = 'default_data'
        data['label_storageColor_for_1'] = 'default_data'
