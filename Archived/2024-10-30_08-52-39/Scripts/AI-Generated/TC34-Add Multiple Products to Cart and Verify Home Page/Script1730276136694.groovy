...
WebUI.takeScreenshot(reportLocation + '/TC34/Step 2-Click on link iPhone15HotNew - Navigate to page product.png')
...
WebUI.takeScreenshot(reportLocation + '/TC34/Step 3-Hover over item Product.png')
...
WebUI.takeScreenshot(reportLocation + '/TC34/Step 4-Click on link Apple - Navigate to page category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC34/Step 5-Click on link brandOptions Apple.png')
...
WebUI.takeScreenshot(reportLocation + '/TC34/Step 6-Click on button Sale20WUSBAdapter.png')
...
WebUI.takeScreenshot(reportLocation + '/TC34/Step 7-Hover over item Category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC34/Step 8-Click on link Accessories.png')
...
WebUI.takeScreenshot(reportLocation + '/TC34/Step 9-Hover over item Category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC34/Step 10-Click on link Accessories.png')
...
WebUI.takeScreenshot(reportLocation + '/TC34/Step 11-Click on button SamsungGalaxyS23Ultra.png')
...
WebUI.takeScreenshot(reportLocation + '/TC34/Step 12-Click on link KCellphoneShop - Navigate to page .png')
...
WebUI.takeScreenshot(reportLocation + '/TC34/Step 13-Click on button AddToCart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC34/Step 14-Click on label productName iPhone15.png')
...
WebUI.takeScreenshot(reportLocation + '/TC34/Step 15-Click on button Buy.png')
...
WebUI.takeScreenshot(reportLocation + '/TC34/Step 16-Click on button ProductAddedToCart - Navigate to page .png')

"Step 17: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC34-Add Multiple Products to Cart and Verify Home Page_visual_checkpoint')
