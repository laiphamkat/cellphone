...
WebUI.mouseOver(findTestObject('AI-Generated/Page_home/item_item_1'))

WebUI.takeScreenshot(reportLocation + '/TC33/Step 4-Hover over item item.png')
...
WebUI.takeScreenshot(reportLocation + '/TC33/Step 5-Click on link apple - Navigate to page category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC33/Step 6-Click on button addToCart addToCart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC33/Step 7-Click on label colorStorageOption 512Gb.png')

"Step 8: Click on label colorStorageOption (green)"
...
WebUI.takeScreenshot(reportLocation + '/TC33/Step 8-Click on label colorStorageOption green.png')
...
WebUI.takeScreenshot(reportLocation + '/TC33/Step 9-Click on button buy.png')
...
WebUI.takeScreenshot(reportLocation + '/TC33/Step 10-Click on link cartNavigation goToCart - Navigate to page cart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC33/Step 11-Click on button proceedToCheckout - Navigate to page checkoutpayment.png')
...
WebUI.takeScreenshot(reportLocation + '/TC33/Step 12-Click on button completeOrder - Navigate to page thank-you.png')

"Step 13: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC33-Complete Order for Apple Item and Verify Thank You Page_visual_checkpoint')
