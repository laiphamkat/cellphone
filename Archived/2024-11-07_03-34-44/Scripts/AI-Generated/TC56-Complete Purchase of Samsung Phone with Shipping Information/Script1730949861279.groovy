...
WebUI.takeScreenshot(reportLocation + '/TC56/Step 2-Hover over item object2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC56/Step 3-Click on link Samsung - Navigate to page category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC56/Step 5-Click on label colorStorageOption Storage512GB.png')

"Step 6: Click on label colorStorageOption (Blue)"
...
WebUI.takeScreenshot(reportLocation + '/TC56/Step 6-Click on label colorStorageOption Blue.png')
...
WebUI.takeScreenshot(reportLocation + '/TC56/Step 7-Click on button Buy.png')
...
WebUI.takeScreenshot(reportLocation + '/TC56/Step 8-Click on link GoToCart - Navigate to page cart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC56/Step 9-Click on button ProceedToCheckout - Navigate to page checkoutinfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC56/Step 10-Hover over div CheckoutInfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC56/Step 11-Click on input Email.png')
...
WebUI.takeScreenshot(reportLocation + '/TC56/Step 12-Enter input value in input Email.png')
...
WebUI.takeScreenshot(reportLocation + '/TC56/Step 13-Click on button ContinueToShipping - Navigate to page checkoutshipping-address.png')
...
WebUI.takeScreenshot(reportLocation + '/TC56/Step 14-Hover over div CheckoutShippingAddress.png')
...
WebUI.takeScreenshot(reportLocation + '/TC56/Step 15-Click on input FirstName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC56/Step 16-Hover over div CheckoutShippingAddress2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC56/Step 17-Enter input value in input FirstName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC56/Step 18-Click on input LastName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC56/Step 19-Hover over div CheckoutShippingAddress3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC56/Step 20-Enter input value in input LastName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC56/Step 21-Click on input Address.png')
...
WebUI.takeScreenshot(reportLocation + '/TC56/Step 22-Hover over div CheckoutShippingAddress4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC56/Step 23-Enter input value in input Address.png')
...
WebUI.takeScreenshot(reportLocation + '/TC56/Step 24-Click on input ZipCode.png')
...
WebUI.takeScreenshot(reportLocation + '/TC56/Step 25-Hover over div CheckoutShippingAddress5.png')
...
WebUI.takeScreenshot(reportLocation + '/TC56/Step 26-Enter input value in input ZipCode.png')
...
WebUI.takeScreenshot(reportLocation + '/TC56/Step 27-Click on input City.png')
...
WebUI.takeScreenshot(reportLocation + '/TC56/Step 28-Hover over div CheckoutShippingAddress6.png')
...
WebUI.takeScreenshot(reportLocation + '/TC56/Step 29-Enter input value in input City.png')
...
WebUI.takeScreenshot(reportLocation + '/TC56/Step 30-Click on input State.png')
...
WebUI.takeScreenshot(reportLocation + '/TC56/Step 31-Hover over div CheckoutShippingAddress7.png')
...
WebUI.takeScreenshot(reportLocation + '/TC56/Step 32-Enter input value in input State.png')
...
WebUI.takeScreenshot(reportLocation + '/TC56/Step 33-Click on input Phone.png')
...
WebUI.takeScreenshot(reportLocation + '/TC56/Step 34-Enter input value in input Phone.png')
...
WebUI.takeScreenshot(reportLocation + '/TC56/Step 35-Click on button ContinueToPayment - Navigate to page checkoutpayment.png')
...
WebUI.takeScreenshot(reportLocation + '/TC56/Step 36-Click on button CompleteOrder - Navigate to page thank-you.png')

"Step 37: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC56-Complete Purchase of Samsung Phone with Shipping Information_visual_checkpoint')
