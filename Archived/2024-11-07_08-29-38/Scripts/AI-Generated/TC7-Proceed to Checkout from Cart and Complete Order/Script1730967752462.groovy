...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 3-Click on link mobileBrands GooglePixel - Navigate to page category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 5-Hover over link GoToCart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 6-Click on span dynamicObject Link1 - Navigate to page cart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 7-Click on div CartSummary.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 8-Click on div CartSummary.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 9-Click on button ProceedToCheckout - Navigate to page checkoutinfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 10-Hover over div CheckoutInfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 13-Click on button ContinueToShipping - Navigate to page checkoutshipping-address.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 14-Hover over div CheckoutShippingAddress.png')

"Step 15: Fill in shipping address details during checkout"
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 16-Click on input State.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 17-Enter input value in input City.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 18-Hover over div CheckoutShippingAddress2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 19-Enter input value in input State.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 20-Click on input Phone.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 21-Enter input value in input Phone.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 22-Click on button ContinueToPayment - Navigate to page checkoutpayment.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 23-Click on button CompleteOrder - Navigate to page .png')

"Step 24: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC7-Proceed to Checkout from Cart and Complete Order_visual_checkpoint')
