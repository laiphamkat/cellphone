...
"Step 6: Click on button productSale (sale20WusbtypeCadapter)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/category/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_category/button_productSale"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_category/button_productSale', ['button_productSale_class': button_productSale_class, 'button_productSale_internalHasText': button_productSale_internalHasText]))

WebUI.takeScreenshot(reportLocation + '/TC5/Step 6-Click on button productSale sale20WusbtypeCadapter.png')
...
"Step 11: Click on button productSale (samsungGalaxyS23Ultra)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/category/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_category/button_productSale"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_category/button_productSale', ['button_productSale_class': button_productSale_class_1, 'button_productSale_internalHasText': button_productSale_internalHasText_1]))

WebUI.takeScreenshot(reportLocation + '/TC5/Step 11-Click on button productSale samsungGalaxyS23Ultra.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC5-Order Apple iPhone 15 and Accessories with Cart Verification_visual_checkpoint')
