...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 3-Click on link brandAndAccessory apple - Navigate to page category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 5-Click on label colorAndStorageOption 512Gb.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 6-Click on label colorAndStorageOption yellow.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC1-Complete Order for Accessories with Shipping Information_visual_checkpoint')
