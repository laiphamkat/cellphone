...
"Step 2: Click on button hotNewProducts (HotNewProduct)"
...
WebUI.takeScreenshot(reportLocation + '/TC29/Step 2-Click on button hotNewProducts HotNewProduct.png')

"Step 3: Click on label colorStorageOptions (512GB) -> Navigate to page ''"
...
WebUI.takeScreenshot(reportLocation + '/TC29/Step 3-Click on label colorStorageOptions 512GB - Navigate to page .png')

"Step 4: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC29-View Hot New Products on Homepage_visual_checkpoint')
