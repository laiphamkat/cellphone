...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 2-Hover over item object2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 3-Click on link mobileBrands GooglePixel - Navigate to page category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 4-Click on link GoToCart.png')

"Step 5: Fill in shipping details and proceed to payment"
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 6-Click on button CompleteOrder - Navigate to page thank-you.png')

"Step 7: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC6-Checkout with Existing Cart Items_visual_checkpoint')
