...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 3-Click on link mobileBrands GooglePixel - Navigate to page category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 4-Click on button addToCart AddToCart2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 5-Hover over link Cart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 6-Click on span dynamicObject object - Navigate to page cart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 7-Click on div CartSummary.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 8-Click on div CartSummary.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 9-Click on button ProceedToCheckout.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 11-Click on button CompleteOrder - Navigate to page .png')

"Step 12: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC8-Complete Order from Cart with Shipping Details_visual_checkpoint')
