...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 3-Click on link Apple - Navigate to page cart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 4-Click on button Increased.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 6-Click on button CompleteOrder - Navigate to page thank-you.png')

"Step 7: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC3-Complete Order for Apple Accessories with Increased Quantity_visual_checkpoint')
