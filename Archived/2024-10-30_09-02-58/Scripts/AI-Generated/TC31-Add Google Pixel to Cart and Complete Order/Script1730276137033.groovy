...
WebUI.takeScreenshot(reportLocation + '/TC31/Step 3-Click on link GooglePixel - Navigate to page category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC31/Step 4-Click on button addToCart AddToCart2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC31/Step 5-Hover over link Cart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC31/Step 6-Click on span object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC31/Step 8-Click on button CompleteOrder - Navigate to page thank-you.png')

"Step 9: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC31-Add Google Pixel to Cart and Complete Order_visual_checkpoint')
