...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 3-Click on link brandNames Apple - Navigate to page category.png')
...
"Step 7: Enter input value in input City"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.setText(findTestObject('AI-Generated/Page_checkout_shipping_address/input_City'), input_City)

WebUI.takeScreenshot(reportLocation + '/TC6/Step 7-Enter input value in input City.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 8-Click on input State.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 9-Hover over div CheckoutShippingAddress2.png')

"Step 10: Enter input value in input State"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.setText(findTestObject('AI-Generated/Page_checkout_shipping_address/input_State'), input_State)

WebUI.takeScreenshot(reportLocation + '/TC6/Step 10-Enter input value in input State.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 11-Click on input Phone.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 12-Enter input value in input Phone.png')

"Step 13: Click on button ContinueToPayment -> Navigate to page 'checkout/payment'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_checkout_shipping_address/button_ContinueToPayment'))

WebUI.takeScreenshot(reportLocation + '/TC6/Step 13-Click on button ContinueToPayment - Navigate to page checkoutpayment.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 14-Click on button CompleteOrder - Navigate to page .png')

"Step 15: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC6-Add to Cart and Complete Checkout with Shipping Details_visual_checkpoint')
