...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 2-Click on button AddToCart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 3-Click on button purchaseActions Increased.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 4-Click on button purchaseActions Increased.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 5-Click on button purchaseActions Increased.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 6-Click on button purchaseActions Increased.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 7-Click on div ProductDetails.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 8-Click on label colorStorageOptions Storage256GB.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 9-Click on label colorStorageOptions ColorSelection.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 10-Click on button Buy2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 11-Hover over link CartNavigation.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 12-Click on span additionalLinks AdditionalLink - Navigate to page cart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 13-Click on button Increased.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 14-Click on button Increased.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 15-Click on button Increased.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 16-Click on button Increased.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 17-Click on button ProceedToCheckout - Navigate to page checkoutinfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 18-Hover over div CheckoutInfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 19-Click on input Email.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 20-Enter input value in input Email.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 21-Click on button ContinueToShipping - Navigate to page checkoutshipping-address.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 22-Hover over div CheckoutShippingAddress.png')

"Step 23: Fill in shipping address details for checkout"
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 25-Click on input State.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 26-Hover over div CheckoutShippingAddress2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 28-Enter input value in input State.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 30-Click on button ContinueToPayment - Navigate to page checkoutpayment.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 31-Click on button CompleteOrder - Navigate to page thank-you.png')

"Step 32: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC9-Complete Checkout for Multiple Product Purchases_visual_checkpoint')
