...
import katalon.common.viewPhoneCategoryAndSearchProducts
...
viewPhoneCategoryAndSearchProducts.execute(data_path_0, Integer.valueOf(index_0))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC11-Verify Successful Payment and Order Completion for iPhone 15 Purchase_visual_checkpoint')
