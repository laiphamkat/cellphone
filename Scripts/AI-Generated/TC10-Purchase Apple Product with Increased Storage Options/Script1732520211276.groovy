...
"Step 4: Click on button HotNewProduct"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/category/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_category/button_HotNewProduct'))

WebUI.takeScreenshot(reportLocation + '/TC10/Step 4-Click on button HotNewProduct.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 5-Click on label storageColorOption Storage512GB.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 6-Click on label storageColorOption Green.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 9-Click on link PlaceAnOrder - Navigate to page cart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 10-Click on link GoToCart.png')

"Step 11: Fill in shipping details and proceed to payment"

completeCheckoutShippingDetails.execute(data_path_0, Integer.valueOf(index_0))

"Step 12: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC10-Purchase Apple Product with Increased Storage Options_visual_checkpoint')
