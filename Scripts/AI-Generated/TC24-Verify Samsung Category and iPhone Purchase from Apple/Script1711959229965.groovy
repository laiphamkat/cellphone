...
import katalon.common.buyIphoneAndAccessoriesFromAppleCategory
...
"Step 15: Click on label  -> Navigate to page ''"
...
"Step 16: Call functional action"

WebUI.takeScreenshot()

buyIphoneAndAccessoriesFromAppleCategory.execute(null, Integer.parseInt(1))

"Step 17: Click on link 'Apple' -> Navigate to page 'category/apple'"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC24-Verify Samsung Category and iPhone Purchase from Apple_visual_checkpoint')
