...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 2-Hover over item accessories.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 3-Click on link samsungPowerAndCables - Navigate to page categorypower-and-cables.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 4-Click on link samsungGalaxyS23UltraSmartviewCases - Navigate to page product.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 5-Click on link productGallery.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 6-Click on button close.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 7-Click on link accessories - Navigate to page categoryaccessories.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 8-Click on link iphone15SiliconeCaseWithMagSafe - Navigate to page product.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 9-Click on label 256Gb1.png')

"Step 10: Click on label blueTitanium"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/product/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_product/label_blueTitanium_15"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_product/label_blueTitanium_15', ['label_blueTitanium_for': label_blueTitanium_for, 'label_blueTitanium_internalText': label_blueTitanium_internalText]))

WebUI.takeScreenshot(reportLocation + '/TC24/Step 10-Click on label blueTitanium.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 11-Hover over div productsSliderProduct.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 12-Click on button addToCart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 13-Click on label 512Gb.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 14-Click on label 512Gb.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 15-Click on button buy.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 16-Click on link goToCart - Navigate to page cart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 17-Click on button increased.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 18-Click on button closeButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 19-Click on button proceedToCheckout - Navigate to page checkoutinfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 20-Click on div headerBody.png')

"Step 21: Fill in shipping details multiple times during checkout"
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 22-Hover over link backToTheCart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 23-Click on link chevronLeftIcon - Navigate to page cart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 24-Hover over item listitem2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 25-Click on link apple - Navigate to page categorychekhly-na-iphone.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 26-Click on button addToCartNewIphone15SiliconeCase.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 27-Click on button addToCartNewIphone15SiliconeCase - Navigate to page .png')

"Step 28: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC24-Browse Accessories and Complete Checkout with Shipping Details_visual_checkpoint')
