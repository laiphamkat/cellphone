...
WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_category_chekhly_na_iphone/link_phone'), 20, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/category/chekhly-na-iphone?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_category_chekhly_na_iphone/link_phone'))
...
"Step 16: Proceed to checkout after selecting items"

WebUI.takeScreenshot()

proceedToCheckout.execute(data_path_1, Integer.valueOf(index_1))

"Step 17: Enter shipping details for payment"

WebUI.takeScreenshot()

enterShippingDetailsForPayment.execute(data_path_2, Integer.valueOf(index_2))

"Step 18: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC14-Verify Payment Details in Checkout Process for iPhone Cases_visual_checkpoint')
