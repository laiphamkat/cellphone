...
import truetest.common.buyQuantityAndProceedToCheckout
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 2-Click on link Apple - Navigate to page categorycategory.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 3-Click on link newArrivals New - Navigate to page productproduct.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 4-Click on label 256GB2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 5-Click on div VariantPicker.png')

"Step 6: Click on label colorOptions (Yellow)"
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 6-Click on label colorOptions Yellow.png')

"Step 7: Select quantity and proceed to checkout with email input"

buyQuantityAndProceedToCheckout.execute(data_path_0, Integer.valueOf(index_0))
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 8-Click on input FirstName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 9-Enter input value in input FirstName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 10-Click on input LastName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 11-Enter input value in input LastName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 12-Click on input Address.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 13-Enter input value in input Address.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 14-Enter input value in input ZipCode.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 15-Click on input City.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 16-Enter input value in input City.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 17-Enter input value in input State.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 18-Click on input Phone.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 19-Enter input value in input Phone.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 20-Click on button ContinueToPayment - Navigate to page checkoutcheckoutpayment.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 21-Click on button CompleteOrder - Navigate to page thank youthank-you.png')

"Step 22: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC10-Checkout Process for New Arrivals in iPhone Cases_visual_checkpoint')
