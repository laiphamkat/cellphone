...
WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_about/link_apple_1'), 20, FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC12-Verify Product Category Display for Apple_visual_checkpoint')
