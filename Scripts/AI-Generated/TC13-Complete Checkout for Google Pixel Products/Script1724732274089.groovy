...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_category_samsung/link_sortOptions_1"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_category_samsung/link_sortOptions_1', ['link_sortOptions_nthChild': link_sortOptions_nthChild, 'link_sortOptions_internalRoleLinkName': link_sortOptions_internalRoleLinkName]))
...
"Step 8: Choose storage options and proceed to checkout"

chooseStorageOptionsAndProceedToCheckout.execute(data_path_0, Integer.valueOf(index_0))

"Step 9: Fill in shipping information and continue to payment"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC13-Complete Checkout for Google Pixel Products_visual_checkpoint')
