...
"Step 4: Click on label 128Gb1"

WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/product/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_product/label_128Gb1'))

WebUI.takeScreenshot(reportLocation + '/TC13/Step 4: Click on label 128Gb1.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 5: Click on label blue.png')
...
"Step 9: Input email and shipping address"

inputEmailAndShippingAddress.execute(data_path_0, Integer.valueOf(index_0))

"Step 10: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC13-Purchase iPhone 15 Pro Max and Proceed to Checkout_visual_checkpoint')
