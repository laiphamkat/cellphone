...
import katalon.common.orderItemsInCartProceedToCheckout
...
orderItemsInCartProceedToCheckout.execute()
...
proceedToCheckoutFillShippingAddressProceedToPayment.execute(data_path_0, Integer.valueOf(index_0))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC13-Verify Successful Order Placement and Payment Process_visual_checkpoint')
