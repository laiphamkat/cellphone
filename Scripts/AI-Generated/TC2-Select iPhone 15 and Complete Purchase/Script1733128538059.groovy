...
"Step 3: Click on link phoneCategory (Phone) -> Navigate to page 'category/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_home/link_phoneCategory"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_home/link_phoneCategory', ['category_id': category_id]))

WebUI.takeScreenshot(reportLocation + '/TC2/Step 3-Click on link phoneCategory Phone - Navigate to page category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 4-Click on link iPhone15 - Navigate to page product.png')

"Step 5: Click on label storageColorOptions (ProductTB)"
...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 5-Click on label storageColorOptions ProductTB.png')
...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 6-Click on label storageColorOptions Blue.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC2-Select iPhone 15 and Complete Purchase_visual_checkpoint')
