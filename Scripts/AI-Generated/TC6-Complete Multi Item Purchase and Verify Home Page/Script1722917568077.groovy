...
import katalon.common.enterEmailAndProceedToShipping
...
"Step 25: Enter email and proceed to shipping for notifications"

enterEmailAndProceedToShipping.execute(data_path_1, Integer.valueOf(index_1))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC6-Complete Multi Item Purchase and Verify Home Page_visual_checkpoint')
