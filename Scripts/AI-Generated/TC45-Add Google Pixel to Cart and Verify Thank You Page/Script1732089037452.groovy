...
WebUI.takeScreenshot(reportLocation + '/TC45/Step 2-Hover over item object2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC45/Step 3-Click on link GooglePixel - Navigate to page category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC45/Step 4-Click on button addToCart AddToCart3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC45/Step 5-Hover over link GoToCart.png')

"Step 6: Click on span dynamicObject (Link1) -> Navigate to page '/cart'"
...
WebUI.takeScreenshot(reportLocation + '/TC45/Step 6-Click on span dynamicObject Link1 - Navigate to page cart.png')

"Step 7: Click on div cartSummary (CartSummary)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/cart?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_cart/div_cartSummary'))

WebUI.takeScreenshot(reportLocation + '/TC45/Step 7-Click on div cartSummary CartSummary.png')

"Step 8: Click on div cartSummary (CartSummary)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/cart?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_cart/div_cartSummary'))

WebUI.takeScreenshot(reportLocation + '/TC45/Step 8-Click on div cartSummary CartSummary.png')
...
WebUI.takeScreenshot(reportLocation + '/TC45/Step 9-Click on button ProceedToCheckout - Navigate to page checkoutinfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC45/Step 10-Hover over div CheckoutInfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC45/Step 11-Click on input Email.png')
...
WebUI.takeScreenshot(reportLocation + '/TC45/Step 12-Enter input value in input Email.png')
...
WebUI.takeScreenshot(reportLocation + '/TC45/Step 13-Click on button ContinueToShipping - Navigate to page checkoutshipping-address.png')
...
WebUI.takeScreenshot(reportLocation + '/TC45/Step 14-Hover over div CheckoutShippingAddress7.png')
...
WebUI.takeScreenshot(reportLocation + '/TC45/Step 15-Click on input FirstName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC45/Step 16-Hover over div CheckoutShippingAddress.png')
...
WebUI.takeScreenshot(reportLocation + '/TC45/Step 17-Enter input value in input FirstName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC45/Step 18-Click on input LastName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC45/Step 19-Hover over div CheckoutShippingAddress2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC45/Step 20-Enter input value in input LastName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC45/Step 21-Click on input Address.png')
...
WebUI.takeScreenshot(reportLocation + '/TC45/Step 22-Hover over div CheckoutShippingAddress3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC45/Step 23-Enter input value in input Address.png')
...
WebUI.takeScreenshot(reportLocation + '/TC45/Step 24-Click on input ZipCode.png')
...
WebUI.takeScreenshot(reportLocation + '/TC45/Step 25-Hover over div CheckoutShippingAddress4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC45/Step 26-Enter input value in input ZipCode.png')
...
WebUI.takeScreenshot(reportLocation + '/TC45/Step 27-Click on input ShippingCity.png')

"Step 28: Hover over div CheckoutShippingAddress5"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.mouseOver(findTestObject('AI-Generated/Page_checkout_shipping_address/div_CheckoutShippingAddress5'))

WebUI.takeScreenshot(reportLocation + '/TC45/Step 28-Hover over div CheckoutShippingAddress5.png')
...
WebUI.takeScreenshot(reportLocation + '/TC45/Step 29-Click on input State.png')

"Step 30: Enter input value in input ShippingCity"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.setText(findTestObject('AI-Generated/Page_checkout_shipping_address/input_ShippingCity'), input_ShippingCity)

WebUI.takeScreenshot(reportLocation + '/TC45/Step 30-Enter input value in input ShippingCity.png')

"Step 31: Hover over div CheckoutShippingAddress6"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.mouseOver(findTestObject('AI-Generated/Page_checkout_shipping_address/div_CheckoutShippingAddress6'))

WebUI.takeScreenshot(reportLocation + '/TC45/Step 31-Hover over div CheckoutShippingAddress6.png')
...
WebUI.takeScreenshot(reportLocation + '/TC45/Step 32-Enter input value in input State.png')
...
WebUI.takeScreenshot(reportLocation + '/TC45/Step 33-Click on input Phone.png')
...
WebUI.takeScreenshot(reportLocation + '/TC45/Step 34-Enter input value in input Phone.png')
...
WebUI.takeScreenshot(reportLocation + '/TC45/Step 35-Click on button ContinueToPayment - Navigate to page checkoutpayment.png')

"Step 36: Click on button CompleteOrder -> Navigate to page ''"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/checkout/payment?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_checkout_payment/button_CompleteOrder'))

WebUI.takeScreenshot(reportLocation + '/TC45/Step 36-Click on button CompleteOrder - Navigate to page .png')

"Step 37: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC45-Add Google Pixel to Cart and Verify Thank You Page_visual_checkpoint')
