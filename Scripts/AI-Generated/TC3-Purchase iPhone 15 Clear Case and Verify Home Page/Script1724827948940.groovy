...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 3-Click on link apple - Navigate to page categorychekhly-na-iphone.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 4-Click on link iphone15ClearCaseWithMagsafe - Navigate to page product.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 8-Click on button completeOrder - Navigate to page .png')

"Step 9: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC3-Purchase iPhone 15 Clear Case and Verify Home Page_visual_checkpoint')
