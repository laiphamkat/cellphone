...
import katalon.common.browseAppleCategorySetPriceRangeSearch
...
browseAppleCategorySetPriceRangeSearch.execute(data_path_0, Integer.valueOf(index_0))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC7-Verify Successful Order Placement and Payment Process for Apple Category_visual_checkpoint')
