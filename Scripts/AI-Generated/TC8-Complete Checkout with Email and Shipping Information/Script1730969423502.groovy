...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 3-Click on link brandNames GooglePixel - Navigate to page category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 4-Click on link GoToCart2 - Navigate to page checkoutinfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 5-Hover over div CheckoutInfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 6-Click on input Email.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 7-Enter input value in input Email.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 8-Click on button ContinueToShipping - Navigate to page checkoutshipping-address.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 9-Hover over div CheckoutShippingAddress.png')

"Step 10: Fill in shipping address details for checkout"
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 11-Enter input value in input City.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 12-Click on input State.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 13-Hover over div CheckoutShippingAddress2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 14-Enter input value in input State.png')

"Step 15: Click on input Phone"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_checkout_shipping_address/input_Phone'))

WebUI.takeScreenshot(reportLocation + '/TC8/Step 15-Click on input Phone.png')

"Step 16: Enter input value in input Phone"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.setText(findTestObject('AI-Generated/Page_checkout_shipping_address/input_Phone'), input_Phone)

WebUI.takeScreenshot(reportLocation + '/TC8/Step 16-Enter input value in input Phone.png')

"Step 17: Click on div DeliveryInformation"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_checkout_shipping_address/div_DeliveryInformation'))

WebUI.takeScreenshot(reportLocation + '/TC8/Step 17-Click on div DeliveryInformation.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 18-Click on button ContinueToPayment - Navigate to page checkoutpayment.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 19-Click on button CompleteOrder - Navigate to page thank-you.png')

"Step 20: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC8-Complete Checkout with Email and Shipping Information_visual_checkpoint')
