...
import truetest.common.browseIphoneAccessoriesAndPlaceOrder
...
"Step 2: Browse iPhone accessories and place an order"

browseIphoneAccessoriesAndPlaceOrder.execute(data_path_0, Integer.valueOf(index_0))

"Step 3: Click on button checkout (ProceedToCheckout) -> Navigate to page 'checkout info#checkout/info'"
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 3-Click on button checkout ProceedToCheckout - Navigate to page checkout infocheckoutinfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 4-Hover over div checkoutInfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 5-Click on input EmailAddress.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 6-Enter input value in input EmailAddress.png')

"Step 7: Press key Enter on input EmailAddress -> Navigate to page 'checkout#checkout/shipping-address'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'checkout/info?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.sendKeys(findTestObject('AI-Generated/Page_checkout_info/input_Email'), Keys.chord(Keys.ENTER))

WebUI.takeScreenshot(reportLocation + '/TC24/Step 7-Press key Enter on input EmailAddress - Navigate to page checkoutcheckoutshipping-address.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 8-Hover over div checkout.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 9-Click on input FirstName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 10-Enter input value in input FirstName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 11-Enter input value in input Address.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 12-Enter input value in input LastName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 13-Press key Tab on input FirstName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 14-Press key Tab on input LastName.png')

"Step 15: Hover over div checkout4"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.mouseOver(findTestObject('AI-Generated/Page_checkout/div_checkout7'))

WebUI.takeScreenshot(reportLocation + '/TC24/Step 15-Hover over div checkout4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 16-Click on input ZipCode.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 17-Enter input value in input ZipCode.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 18-Enter input value in input City.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 19-Enter input value in input State.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 20-Enter input value in input Phone.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 21-Press key Tab on input ZipCode.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 22-Press key Tab on input City.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 23-Press key Tab on input State.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 24-Press key Enter on input Phone - Navigate to page checkoutcheckoutpayment.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 25-Click on button CompleteOrder - Navigate to page thank youthank-you.png')

"Step 26: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC24-Complete Order for iPhone Accessories with Detailed Checkout_visual_checkpoint')
