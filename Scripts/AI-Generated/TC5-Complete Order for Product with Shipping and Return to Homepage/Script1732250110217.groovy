...
"Step 2: Click on link product (iPhone15Pro) -> Navigate to page 'product/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_home/link_product"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_home/link_product', ['product_id': product_id]))

WebUI.takeScreenshot(reportLocation + '/TC5/Step 2-Click on link product iPhone15Pro - Navigate to page product.png')

"Step 3: Click on label productDetails (ProductTB)"
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 3-Click on label productDetails ProductTB.png')

"Step 4: Click on label productDetails (BlueTitanium)"
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 4-Click on label productDetails BlueTitanium.png')

"Step 5: Click on link cartNavigation (GoToCart2) -> Navigate to page 'checkout/info'"
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 5-Click on link cartNavigation GoToCart2 - Navigate to page checkoutinfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 6-Hover over div CheckoutInfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 7-Click on input Email.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 8-Enter input value in input Email.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 9-Click on button ContinueToShipping - Navigate to page checkoutshipping-address.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 10-Hover over div CheckoutShippingAddress.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 11-Click on input FirstName.png')

"Step 12: Hover over div CheckoutShippingAddress2"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.mouseOver(findTestObject('AI-Generated/Page_checkout_shipping_address/div_CheckoutShippingAddress2'))

WebUI.takeScreenshot(reportLocation + '/TC5/Step 12-Hover over div CheckoutShippingAddress2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 13-Enter input value in input FirstName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 14-Click on input LastName.png')

"Step 15: Hover over div CheckoutShippingAddress3"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.mouseOver(findTestObject('AI-Generated/Page_checkout_shipping_address/div_CheckoutShippingAddress3'))

WebUI.takeScreenshot(reportLocation + '/TC5/Step 15-Hover over div CheckoutShippingAddress3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 16-Enter input value in input LastName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 17-Click on input Address.png')

"Step 18: Hover over div CheckoutShippingAddress4"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.mouseOver(findTestObject('AI-Generated/Page_checkout_shipping_address/div_CheckoutShippingAddress4'))

WebUI.takeScreenshot(reportLocation + '/TC5/Step 18-Hover over div CheckoutShippingAddress4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 19-Enter input value in input Address.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 20-Click on input ZipCode.png')

"Step 21: Hover over div CheckoutShippingAddress5"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.mouseOver(findTestObject('AI-Generated/Page_checkout_shipping_address/div_CheckoutShippingAddress5'))

WebUI.takeScreenshot(reportLocation + '/TC5/Step 21-Hover over div CheckoutShippingAddress5.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 22-Click on input ShippingCity.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 23-Enter input value in input ZipCode.png')

"Step 24: Hover over div CheckoutShippingAddress6"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.mouseOver(findTestObject('AI-Generated/Page_checkout_shipping_address/div_CheckoutShippingAddress6'))

WebUI.takeScreenshot(reportLocation + '/TC5/Step 24-Hover over div CheckoutShippingAddress6.png')

"Step 25: Enter input value in input ShippingCity"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.setText(findTestObject('AI-Generated/Page_checkout_shipping_address/input_ShippingCity'), input_ShippingCity)

WebUI.takeScreenshot(reportLocation + '/TC5/Step 25-Enter input value in input ShippingCity.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 26-Click on input State.png')

"Step 27: Hover over div CheckoutShippingAddress7"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.mouseOver(findTestObject('AI-Generated/Page_checkout_shipping_address/div_CheckoutShippingAddress7'))

WebUI.takeScreenshot(reportLocation + '/TC5/Step 27-Hover over div CheckoutShippingAddress7.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 28-Enter input value in input State.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 29-Click on input Phone.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 30-Enter input value in input Phone.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 31-Click on button ContinueToPayment - Navigate to page checkoutpayment.png')

"Step 32: Click on button CompleteOrder -> Navigate to page ''"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/checkout/payment?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_checkout_payment/button_CompleteOrder'))

WebUI.takeScreenshot(reportLocation + '/TC5/Step 32-Click on button CompleteOrder - Navigate to page .png')

"Step 33: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC5-Complete Order for Product with Shipping and Return to Homepage_visual_checkpoint')
