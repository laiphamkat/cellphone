import katalon.common.proceedCheckoutWithEmailAndShippingInfo
...
proceedCheckoutWithEmailAndShippingInfo.execute(data_path_0, Integer.valueOf(index_0))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC2-Verify Checkout Process with Email and Shipping Information Entry_visual_checkpoint')
