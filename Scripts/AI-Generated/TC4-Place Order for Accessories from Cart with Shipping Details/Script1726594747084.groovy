...
"Step 3: Click on link brandAndAccessory (apple) -> Navigate to page 'category/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 3-Click on link brandAndAccessory apple - Navigate to page category.png')
...
"Step 5: Click on label colorAndStorageOption (512Gb)"
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 5-Click on label colorAndStorageOption 512Gb.png')

"Step 6: Click on label colorAndStorageOption (yellow)"
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 6-Click on label colorAndStorageOption yellow.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 10-Click on button completeOrder - Navigate to page thank-you.png')

"Step 11: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC4-Place Order for Accessories from Cart with Shipping Details_visual_checkpoint')
