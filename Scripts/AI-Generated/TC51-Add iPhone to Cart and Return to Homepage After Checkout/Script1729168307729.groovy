...
WebUI.takeScreenshot(reportLocation + '/TC51/Step 2-Click on button addToCart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC51/Step 3-Click on button purchaseOptions IncreaseQuantity.png')
...
WebUI.takeScreenshot(reportLocation + '/TC51/Step 4-Click on button purchaseOptions IncreaseQuantity.png')
...
WebUI.takeScreenshot(reportLocation + '/TC51/Step 5-Click on label colorStorageOptions 256GB.png')

"Step 6: Click on label colorStorageOptions (ColorSelection)"
...
WebUI.takeScreenshot(reportLocation + '/TC51/Step 6-Click on label colorStorageOptions ColorSelection.png')
...
WebUI.takeScreenshot(reportLocation + '/TC51/Step 7-Click on button purchaseOptions Buy.png')
...
WebUI.takeScreenshot(reportLocation + '/TC51/Step 8-Hover over link CartNavigation.png')

"Step 9: Click on span dynamicObject (StorageInformation) -> Navigate to page 'shopping cart#cart'"
...
WebUI.takeScreenshot(reportLocation + '/TC51/Step 9-Click on span dynamicObject StorageInformation - Navigate to page shopping cartcart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC51/Step 10-Click on button IncreaseQuantity.png')

"Step 11: Complete shipping information for checkout process"
...
WebUI.takeScreenshot(reportLocation + '/TC51/Step 12-Click on button CompleteOrder - Navigate to page .png')

"Step 13: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC51-Add iPhone to Cart and Return to Homepage After Checkout_visual_checkpoint')
