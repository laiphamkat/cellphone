...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 2-Click on link brandNames Samsung - Navigate to page categorycategory.png')
...
"Step 8: Click on link CategoryApple"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'category/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_category/link_CategoryApple'))

WebUI.takeScreenshot(reportLocation + '/TC2/Step 8-Click on link CategoryApple.png')
...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 9-Click on link GoToCart.png')

"Step 10: Fill in the checkout information and proceed to payment"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC2-Add Item to Cart and Verify Return to Home Page_visual_checkpoint')
