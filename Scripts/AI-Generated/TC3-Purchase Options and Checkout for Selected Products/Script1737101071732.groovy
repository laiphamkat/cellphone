...
"Step 2: Hover over item Default2"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.mouseOver(findTestObject('AI-Generated/Page_home/item_Default2'))

WebUI.takeScreenshot(reportLocation + '/TC3/Step 2-Hover over item Default2.png')

"Step 3: Click on link brandNames (Apple) -> Navigate to page 'category#category/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 3-Click on link brandNames Apple - Navigate to page categorycategory.png')

"Step 4: Click on link productCategories (productItems) -> Navigate to page 'product listing#product/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 4-Click on link productCategories productItems - Navigate to page product listingproduct.png')

"Step 5: Click on label colorStorageOptions (512GB)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'product/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_product_listing/label_colorStorageOptions"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_product_listing/label_colorStorageOptions', ['label_colorStorageOptions_for': label_colorStorageOptions_for, 'label_colorStorageOptions_internalText': label_colorStorageOptions_internalText]))

WebUI.takeScreenshot(reportLocation + '/TC3/Step 5-Click on label colorStorageOptions 512GB.png')
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_product_listing/label_colorStorageOptions"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_product_listing/label_colorStorageOptions', ['label_colorStorageOptions_for': label_colorStorageOptions_for_1, 'label_colorStorageOptions_internalText': label_colorStorageOptions_internalText_1]))
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 7-Click on button purchaseOptions Buy2.png')

"Step 8: Click on link GoToCart -> Navigate to page 'display list of items:/{fixed page}'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'product/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_product_listing/link_GoToCart'))

WebUI.takeScreenshot(reportLocation + '/TC3/Step 8-Click on link GoToCart - Navigate to page display list of itemsfixed page.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 9-Click on button ProceedToCheckout - Navigate to page formfixed partfixed page.png')

"Step 10: Hover over div Default"
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 10-Hover over div Default.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 11-Click on input Email.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 12-Enter input value in input Email.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 13-Click on button ContinueToShipping.png')

"Step 14: Hover over div Default"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/form:/{fixed_part}/{fixed_page}?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.mouseOver(findTestObject('AI-Generated/Page_form_fixed_part_fixed_page/div_Default'))

WebUI.takeScreenshot(reportLocation + '/TC3/Step 14-Hover over div Default.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 15-Click on input Email.png')

"Step 16: Enter input value in input Email"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/form:/{fixed_part}/{fixed_page}?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.setText(findTestObject('AI-Generated/Page_form_fixed_part_fixed_page/input_Email'), input_Email_1)

WebUI.takeScreenshot(reportLocation + '/TC3/Step 16-Enter input value in input Email.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 17-Click on button ContinueToShipping.png')

"Step 18: Hover over div Default2"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/form:/{fixed_part}/{fixed_page}?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.mouseOver(findTestObject('AI-Generated/Page_form_fixed_part_fixed_page/div_Default2'))

WebUI.takeScreenshot(reportLocation + '/TC3/Step 18-Hover over div Default2.png')
...
"Step 20: Hover over div Default3"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/form:/{fixed_part}/{fixed_page}?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.mouseOver(findTestObject('AI-Generated/Page_form_fixed_part_fixed_page/div_Default3'))

WebUI.takeScreenshot(reportLocation + '/TC3/Step 20-Hover over div Default3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 21-Enter input value in input FirstName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 22-Click on input LastName.png')

"Step 23: Hover over div Default4"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/form:/{fixed_part}/{fixed_page}?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.mouseOver(findTestObject('AI-Generated/Page_form_fixed_part_fixed_page/div_Default4'))

WebUI.takeScreenshot(reportLocation + '/TC3/Step 23-Hover over div Default4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 24-Enter input value in input LastName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 25-Click on input Address.png')

"Step 26: Hover over div Default5"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/form:/{fixed_part}/{fixed_page}?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.mouseOver(findTestObject('AI-Generated/Page_form_fixed_part_fixed_page/div_Default5'))

WebUI.takeScreenshot(reportLocation + '/TC3/Step 26-Hover over div Default5.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 27-Enter input value in input Address.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 28-Click on input ZipCode.png')

"Step 29: Hover over div Default6"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/form:/{fixed_part}/{fixed_page}?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.mouseOver(findTestObject('AI-Generated/Page_form_fixed_part_fixed_page/div_Default6'))

WebUI.takeScreenshot(reportLocation + '/TC3/Step 29-Hover over div Default6.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 30-Enter input value in input ZipCode.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 31-Click on input City.png')

"Step 32: Hover over div Default7"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/form:/{fixed_part}/{fixed_page}?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.mouseOver(findTestObject('AI-Generated/Page_form_fixed_part_fixed_page/div_Default7'))

WebUI.takeScreenshot(reportLocation + '/TC3/Step 32-Hover over div Default7.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 33-Enter input value in input City.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 34-Click on input State.png')

"Step 35: Hover over div Default8"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/form:/{fixed_part}/{fixed_page}?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.mouseOver(findTestObject('AI-Generated/Page_form_fixed_part_fixed_page/div_Default8'))

WebUI.takeScreenshot(reportLocation + '/TC3/Step 35-Hover over div Default8.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 36-Enter input value in input State.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 37-Click on input Phone.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 38-Enter input value in input Phone.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 39-Click on button ContinueToPayment.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 40-Click on button CompleteOrder - Navigate to page .png')

"Step 41: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC3-Purchase Options and Checkout for Selected Products_visual_checkpoint')
