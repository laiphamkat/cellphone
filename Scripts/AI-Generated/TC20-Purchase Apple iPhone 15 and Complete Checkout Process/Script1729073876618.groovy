...
WebUI.takeScreenshot(reportLocation + '/TC20/Step 3-Click on link Apple - Navigate to page category pagecategory.png')
...
WebUI.takeScreenshot(reportLocation + '/TC20/Step 4-Click on button HotNewIPhone15.png')
...
WebUI.takeScreenshot(reportLocation + '/TC20/Step 5-Click on label storageColorOption Storage512GB.png')
...
WebUI.takeScreenshot(reportLocation + '/TC20/Step 6-Click on label storageColorOption ColorYellow.png')
...
WebUI.takeScreenshot(reportLocation + '/TC20/Step 7-Click on button purchaseActions Increased.png')
...
WebUI.takeScreenshot(reportLocation + '/TC20/Step 8-Click on button purchaseActions Buy.png')
...
WebUI.takeScreenshot(reportLocation + '/TC20/Step 10-Click on span dynamicObject Link2 - Navigate to page cart pagecart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC20/Step 11-Click on button Increased.png')
...
WebUI.takeScreenshot(reportLocation + '/TC20/Step 13-Click on button CompleteOrder - Navigate to page thank you pagethank-you.png')

"Step 14: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC20-Purchase Apple iPhone 15 and Complete Checkout Process_visual_checkpoint')
