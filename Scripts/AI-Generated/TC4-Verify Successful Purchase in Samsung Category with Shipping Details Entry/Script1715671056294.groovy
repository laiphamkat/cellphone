...
"Step 13: Enter shipping address and complete payment"

enterShippingAddressAndCompletePayment.execute(data_path_0, Integer.valueOf(index_0))

"Step 14: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC4-Verify Successful Purchase in Samsung Category with Shipping Details Entry_visual_checkpoint')
