...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 2-Hover over item productCategories accessories.png')
...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_category_accessories/button_sale20WusbtypeCadapter'))

WebUI.takeScreenshot(reportLocation + '/TC1/Step 4-Click on button sale20WusbtypeCadapter.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 7-Hover over div email.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC1-Purchase Sale Accessories with Checkout Process_visual_checkpoint')
