...
import katalon.common.buyItemsAndProceedToCheckout
...
"Step 20: Buy items and proceed to checkout"

buyItemsAndProceedToCheckout.execute(data_path_1, Integer.valueOf(index_1))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC8-Verify Order Completion after Adding Items to Cart and Proceeding to Checkout_visual_checkpoint')
