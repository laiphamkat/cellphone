...
import katalon.common.chooseStorageOptionsAndProceedToCheckout
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 2-Hover over item productCategories accessories.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 3-Click on link samsung2 - Navigate to page categorypower-and-cables.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 7-Click on link samsungAccessories samsungGalaxyS23UltraSmartviewCases - Navigate to page product.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 10-Click on label storageColorOptions 256Gb.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 11-Click on label storageColorOptions blueTitanium.png')

"Step 12: Choose storage options and proceed to checkout"

chooseStorageOptionsAndProceedToCheckout.execute(data_path_0, Integer.valueOf(index_0))

"Step 13: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC8-Select Samsung Accessories and Checkout_visual_checkpoint')
