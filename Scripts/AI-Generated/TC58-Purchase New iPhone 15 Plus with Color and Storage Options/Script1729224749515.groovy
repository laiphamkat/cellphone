...
WebUI.takeScreenshot(reportLocation + '/TC58/Step 2-Click on button NewiPhone15Plus.png')
...
WebUI.takeScreenshot(reportLocation + '/TC58/Step 3-Click on button purchaseOptions IncreaseQuantity.png')
...
WebUI.takeScreenshot(reportLocation + '/TC58/Step 4-Click on label colorStorageOptions 256GB.png')
...
WebUI.takeScreenshot(reportLocation + '/TC58/Step 5-Click on label colorStorageOptions ColorSelection.png')
...
WebUI.takeScreenshot(reportLocation + '/TC58/Step 6-Click on button purchaseOptions Buy.png')
...
WebUI.takeScreenshot(reportLocation + '/TC58/Step 7-Hover over link CartNavigation.png')
...
WebUI.takeScreenshot(reportLocation + '/TC58/Step 8-Click on span informationLinks link - Navigate to page cart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC58/Step 9-Click on button IncreaseQuantity.png')

"Step 10: Enter shipping details and continue to payment section"
...
WebUI.takeScreenshot(reportLocation + '/TC58/Step 11-Click on button CompleteOrder - Navigate to page thank-you.png')

"Step 12: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC58-Purchase New iPhone 15 Plus with Color and Storage Options_visual_checkpoint')
