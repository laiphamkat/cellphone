...
import katalon.common.enterEmailForNewsAndContinueToShipping
...
browseAccessoriesAndPurchaseIphone15Plus.execute()
...
"Step 25: Enter email for news and continue to shipping"

enterEmailForNewsAndContinueToShipping.execute(data_path_0, Integer.valueOf(index_0))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC6-Purchase Multiple Items Including iPhone 15 Plus and Samsung Galaxy S23_visual_checkpoint')
