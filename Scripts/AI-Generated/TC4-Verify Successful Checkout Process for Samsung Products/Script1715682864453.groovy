...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_category/label_blueText'))
...
"Step 13: Input shipping address details, continue to payment"

inputShippingAddressDetailsContinueToPayment.execute(data_path_0, Integer.valueOf(index_0))

"Step 14: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC4-Verify Successful Checkout Process for Samsung Products_visual_checkpoint')
