...
import katalon.common.searchPhonesByPriceRange
...
"Step 2: Search for phones within specified price range"

WebUI.takeScreenshot()

searchPhonesByPriceRange.execute(data_path_0, Integer.valueOf(index_0))
...
"Step 9: Proceed through checkout process with shipping details"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC11-Verify Successful Order of iPhone 15_visual_checkpoint')
