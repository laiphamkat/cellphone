...
import katalon.common.buySamsungGalaxyZFold4SiliconCoverAndProceedToCheckout
...
"Step 5: Click on button 'Search' -> Navigate to page ''"
...
buySamsungGalaxyZFold4SiliconCoverAndProceedToCheckout.execute(null, Integer.parseInt(1))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC10-Verify Successful Checkout Process for Samsung Galaxy Z Fold4 Silicon Cover_visual_checkpoint')
