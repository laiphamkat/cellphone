...
import katalon.common.clickObjectsByPriceToBuyAndProceedToCheckout
...
clickObjectsByPriceToBuyAndProceedToCheckout.execute()
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC7-Verify Successful Purchase with Price Filtering_visual_checkpoint')
