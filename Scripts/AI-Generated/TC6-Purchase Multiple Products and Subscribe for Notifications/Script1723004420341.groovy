...
subscribeToEmailUpdatesForShipping.execute(data_path_1, Integer.valueOf(index_1))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC6-Purchase Multiple Products and Subscribe for Notifications_visual_checkpoint')
