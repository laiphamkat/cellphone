...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 2-Hover over item object3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 3-Click on link productCategories Apple2 - Navigate to page category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 5-Click on label storageColorCapacity 256GB.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 6-Click on label storageColorCapacity Green.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 7-Click on button purchaseOptions Buy.png')

"Step 8: Click on link cartNavigation (GoToCart) -> Navigate to page '/cart'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/category/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_category/link_GoToCart3"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_category/link_GoToCart3', ['link_cartNavigation_internalRoleLinkName': link_cartNavigation_internalRoleLinkName]))

WebUI.takeScreenshot(reportLocation + '/TC4/Step 8-Click on link cartNavigation GoToCart - Navigate to page cart.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC4-Purchase New Product with Shipping Details_visual_checkpoint')
