...
"Step 7: Click on button samsungDevices (samsungGalaxyZfold4)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/category/power-and-cables?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_category_power_and_cables/button_samsungDevices"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_category_power_and_cables/button_samsungDevices', ['button_samsungDevices_class': button_samsungDevices_class, 'button_samsungDevices_internalHasText': button_samsungDevices_internalHasText]))

WebUI.takeScreenshot(reportLocation + '/TC12/Step 7-Click on button samsungDevices samsungGalaxyZfold4.png')

"Step 8: Click on button samsungDevices (samsungGalaxyS23Ultra)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/category/power-and-cables?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_category_power_and_cables/button_samsungDevices"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_category_power_and_cables/button_samsungDevices', ['button_samsungDevices_class': button_samsungDevices_class_1, 'button_samsungDevices_internalHasText': button_samsungDevices_internalHasText_1]))

WebUI.takeScreenshot(reportLocation + '/TC12/Step 8-Click on button samsungDevices samsungGalaxyS23Ultra.png')
...
"Step 11: Click on link brand (samsung) -> Navigate to page '/category/samsung'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/product/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_product/link_brand'))

WebUI.takeScreenshot(reportLocation + '/TC12/Step 11-Click on link brand samsung - Navigate to page categorysamsung.png')
...
"Step 15: Click on button samsungDevices (samsungGalaxyZfold5)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/category/samsung?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_category_samsung/button_samsungDevices"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_category_samsung/button_samsungDevices', ['button_samsungDevices_class': button_samsungDevices_class_2, 'button_samsungDevices_internalHasText': button_samsungDevices_internalHasText_2]))

WebUI.takeScreenshot(reportLocation + '/TC12/Step 15-Click on button samsungDevices samsungGalaxyZfold5.png')
...
"Step 29: Click on button samsungDevices (hotSamsungGalaxyS23)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/category/samsung?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_category_samsung/button_samsungDevices"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_category_samsung/button_samsungDevices', ['button_samsungDevices_class': button_samsungDevices_class_3, 'button_samsungDevices_internalHasText': button_samsungDevices_internalHasText_3]))

WebUI.takeScreenshot(reportLocation + '/TC12/Step 29-Click on button samsungDevices hotSamsungGalaxyS23.png')
...
"Step 32: Click on label colorStorageOptions (256Gb)"
...
WebUI.takeScreenshot(reportLocation + '/TC12/Step 32-Click on label colorStorageOptions 256Gb.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC12-Explore and Purchase Various Mobile Devices and Accessories_visual_checkpoint')
