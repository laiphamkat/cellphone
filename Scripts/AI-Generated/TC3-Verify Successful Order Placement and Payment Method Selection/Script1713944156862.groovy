...
import katalon.common.enterShippingAddressForPayment
...
"Step 6: Proceed to checkout after providing email"

WebUI.takeScreenshot()

proceedToCheckoutWithEmail.execute(data_path_0, Integer.valueOf(index_0))

"Step 7: Enter shipping address details for payment"

WebUI.takeScreenshot()

enterShippingAddressForPayment.execute(data_path_1, Integer.valueOf(index_1))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC3-Verify Successful Order Placement and Payment Method Selection_visual_checkpoint')
