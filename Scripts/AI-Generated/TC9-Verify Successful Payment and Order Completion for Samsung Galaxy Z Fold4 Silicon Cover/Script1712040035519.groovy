import katalon.common.viewAccessoriesCategoryAndSearchProducts
...
viewAccessoriesCategoryAndSearchProducts.execute(data_path_0, Integer.valueOf(index_0))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC9-Verify Successful Payment and Order Completion for Samsung Galaxy Z Fold4 Silicon Cover_visual_checkpoint')
