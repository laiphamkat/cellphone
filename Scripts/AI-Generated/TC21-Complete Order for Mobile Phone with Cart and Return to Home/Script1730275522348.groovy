...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 2-Hover over item object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 3-Click on link mobileBrands Apple - Navigate to page category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 4-Click on button addToCart AddToCart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 5-Click on label colorStorageOptions Storage512GB.png')
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 6-Click on label colorStorageOptions Color.png')
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 7-Click on button buyNow Buy.png')
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 9-Click on button ProceedToCheckout.png')
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 11-Click on button CompleteOrder - Navigate to page .png')

"Step 12: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC21-Complete Order for Mobile Phone with Cart and Return to Home_visual_checkpoint')
