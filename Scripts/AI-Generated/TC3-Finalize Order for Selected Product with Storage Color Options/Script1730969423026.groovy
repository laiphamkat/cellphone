...
"Step 4: Click on label storageColorOptions (Storage512GB)"
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 4-Click on label storageColorOptions Storage512GB.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 5-Click on label storageColorOptions Green.png')

"Step 6: Hover over link GoToCart -> Navigate to page 'checkout/payment'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/category/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.mouseOver(findTestObject('AI-Generated/Page_category/link_GoToCart'))

WebUI.takeScreenshot(reportLocation + '/TC3/Step 6-Hover over link GoToCart - Navigate to page checkoutpayment.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 7-Click on button CompleteOrder - Navigate to page thank-you.png')

"Step 8: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC3-Finalize Order for Selected Product with Storage Color Options_visual_checkpoint')
