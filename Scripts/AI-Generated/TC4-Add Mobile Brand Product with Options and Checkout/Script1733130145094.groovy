...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 4-Click on button addToCart AddToCart2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 5-Click on label storageColorOptions Storage256GB.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 8-Click on link cartNavigation GoToCart2.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC4-Add Mobile Brand Product with Options and Checkout_visual_checkpoint')
