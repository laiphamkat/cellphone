...
import katalon.common.proceedToCheckoutSelectItems
import katalon.truetest.TrueTestScripts
import static com.kms.katalon.core.testobject.ObjectRepository.findTestObject
import katalon.common.fillShippingAddressForPayment
...
proceedToCheckoutSelectItems.execute(data_path_0, Integer.valueOf(index_0))

"Step 5: Fill shipping address details for payment"

WebUI.takeScreenshot()

fillShippingAddressForPayment.execute(data_path_1, Integer.valueOf(index_1))

"Step 6: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC1-Verify Successful Checkout Process from Home to Payment_visual_checkpoint')
