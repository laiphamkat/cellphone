...
WebUI.takeScreenshot(reportLocation + '/TC30/Step 4-Click on link samsung - Navigate to page category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC30/Step 5-Click on link samsungGalaxyS23Ultra - Navigate to page product.png')
...
WebUI.takeScreenshot(reportLocation + '/TC30/Step 6-Click on label 512Gb.png')
...
WebUI.takeScreenshot(reportLocation + '/TC30/Step 7-Click on label blue.png')
...
WebUI.takeScreenshot(reportLocation + '/TC30/Step 8-Click on label black.png')
...
WebUI.takeScreenshot(reportLocation + '/TC30/Step 9-Click on button buy.png')
...
WebUI.takeScreenshot(reportLocation + '/TC30/Step 10-Click on link cart.png')
...
"Step 12: Click on span continueToShipping"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/checkout/payment?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_checkout_payment/span_continueToShipping'))

WebUI.takeScreenshot(reportLocation + '/TC30/Step 12-Click on span continueToShipping.png')

"Step 13: Click on input firstName -> Navigate to page ''"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/checkout/payment?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_checkout_payment/input_firstName'))

WebUI.takeScreenshot(reportLocation + '/TC30/Step 13-Click on input firstName - Navigate to page .png')

"Step 14: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC30-Initiate Checkout for Samsung Galaxy S23 Ultra with Shipping Information_visual_checkpoint')
