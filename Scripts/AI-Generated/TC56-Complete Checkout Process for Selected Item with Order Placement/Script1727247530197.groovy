...
WebUI.takeScreenshot(reportLocation + '/TC56/Step 4-Hover over item item.png')

"Step 5: Click on link brand (apple) -> Navigate to page 'category/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC56/Step 5-Click on link brand apple - Navigate to page category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC56/Step 6-Click on button addToCart addToCart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC56/Step 7-Click on label colorStorageOption 512Gb.png')

"Step 8: Click on label colorStorageOption (yellow)"
...
WebUI.takeScreenshot(reportLocation + '/TC56/Step 8-Click on label colorStorageOption yellow.png')
...
WebUI.takeScreenshot(reportLocation + '/TC56/Step 9-Click on button buy.png')

"Step 10: Click on link placeAnOrder"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/category/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_category/link_placeAnOrder'))

WebUI.takeScreenshot(reportLocation + '/TC56/Step 10-Click on link placeAnOrder.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC56-Complete Checkout Process for Selected Item with Order Placement_visual_checkpoint')
