...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 4-Click on button newMobilePhone NewIphone15Plus.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 5-Click on label storageAndColorOptions 256GB.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 6-Click on label storageAndColorOptions Color2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 7-Click on button purchase Buy.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC3-Purchase New Mobile Phone with Storage and Color Options_visual_checkpoint')
