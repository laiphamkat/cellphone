...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 3-Click on link categoryChekhlyNaIphone - Navigate to page category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 7-Click on button proceedToCheckout.png')

"Step 8: Subscribe to email updates and proceed to shipping"
...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 9-Click on button completeOrder - Navigate to page .png')

"Step 10: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC2-Complete Order for Accessories and Verify Home Page_visual_checkpoint')
