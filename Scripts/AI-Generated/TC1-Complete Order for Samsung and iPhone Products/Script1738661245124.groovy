...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 2-Click on link Samsung - Navigate to page categorycategory.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 3-Click on link SamsungGalaxyS23Ultra - Navigate to page productproduct.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 4-Click on label colorStorageOption TB.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 5-Click on label colorStorageOption White.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 6-Click on label colorStorageOption Black.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 7-Click on label colorStorageOption 256GB.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 9-Click on link iPhone15Pro.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 11-Click on link PlaceAnOrder - Navigate to page cartcart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 12-Click on button ProceedToCheckout - Navigate to page checkout infocheckoutinfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 13-Click on input Email.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 14-Enter input value in input Email.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 15-Click on button ContinueToShipping - Navigate to page checkoutcheckoutshipping-address.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 20-Click on input Address.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 23-Enter input value in input ZipCode.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 24-Click on input City.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 27-Enter input value in input State.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 28-Click on input Phone.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 29-Enter input value in input Phone.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 30-Click on button ContinueToPayment - Navigate to page checkoutcheckoutpayment.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 31-Click on button CompleteOrder - Navigate to page thank youthank-you.png')

"Step 32: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC1-Complete Order for Samsung and iPhone Products_visual_checkpoint')
