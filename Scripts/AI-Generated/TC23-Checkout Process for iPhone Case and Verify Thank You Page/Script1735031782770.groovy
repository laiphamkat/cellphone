...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 3-Click on link productBrands Apple3 - Navigate to page category.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC23-Checkout Process for iPhone Case and Verify Thank You Page_visual_checkpoint')
