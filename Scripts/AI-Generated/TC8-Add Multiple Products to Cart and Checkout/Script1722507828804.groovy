...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 3: Click on link categoryChekhlyNaIphone - Navigate to page category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 4: Click on link productApple20Wusbadapter - Navigate to page product.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 6: Click on label 256Gb.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 7: Hover over div productsSliderProduct.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 8: Click on button addToCart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 9: Click on label 512Gb.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 10: Click on label 512Gb.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 11: Click on button buy2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 12: Click on link goToCart - Navigate to page cart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 13: Click on button increased.png')

"Step 14: Complete checkout process with shipping information"

completeCheckoutWithShippingInformation.execute(data_path_0, Integer.valueOf(index_0))

"Step 15: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC8-Add Multiple Products to Cart and Checkout_visual_checkpoint')
