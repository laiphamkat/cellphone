...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 3: Click on link categoryChekhlyNaIphone - Navigate to page category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 4: Click on button productsItemInStock.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 6: Click on button closeButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 7: Click on link productApple20Wusbadapter - Navigate to page product.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 8: Hover over item accessories.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 9: Click on link categoryChekhlyNaIphone - Navigate to page category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 10: Click on link productApple20Wusbadapter - Navigate to page product.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 11: Hover over item accessories.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 12: Click on link categoryChekhlyNaIphone - Navigate to page category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 13: Click on link categorySamsung.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 14: Click on link categorySamsung.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 15: Hover over item accessories.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 16: Click on link apple - Navigate to page .png')

"Step 17: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC9-Explore Accessories and Verify Home Page_visual_checkpoint')
