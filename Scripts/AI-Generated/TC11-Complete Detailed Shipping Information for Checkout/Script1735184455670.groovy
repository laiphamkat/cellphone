...
"Step 11: Click on input FirstName3"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_checkout_shipping_address/input_FirstName_1'))

WebUI.takeScreenshot(reportLocation + '/TC11/Step 11-Click on input FirstName3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC11/Step 12-Click on input FirstName3.png')
...
"Step 14: Enter input value in input FirstName3"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.setText(findTestObject('AI-Generated/Page_checkout_shipping_address/input_FirstName_1'), input_FirstName3)

WebUI.takeScreenshot(reportLocation + '/TC11/Step 14-Enter input value in input FirstName3.png')
