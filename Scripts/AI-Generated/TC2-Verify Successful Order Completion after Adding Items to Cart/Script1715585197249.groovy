...
"Step 7: Enter shipping details and complete order"

enterShippingDetailsAndCompleteOrder.execute(data_path_0, Integer.valueOf(index_0))

"Step 8: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC2-Verify Successful Order Completion after Adding Items to Cart_visual_checkpoint')
