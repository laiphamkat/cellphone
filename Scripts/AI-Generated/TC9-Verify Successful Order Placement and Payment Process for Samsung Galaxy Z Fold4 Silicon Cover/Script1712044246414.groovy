import katalon.common.browseAccessoriesCategorySetPriceRangeSearch
...
browseAccessoriesCategorySetPriceRangeSearch.execute(data_path_0, Integer.valueOf(index_0))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC9-Verify Successful Order Placement and Payment Process for Samsung Galaxy Z Fold4 Silicon Cover_visual_checkpoint')
