...
"Step 9: Click on link productApple20WusbcpowerAdapter -> Navigate to page 'product/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/category/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_category/link_productApple20WusbcpowerAdapter', ['class': link_productApple20WusbcpowerAdapter_class, 'internalRoleLinkName': link_productApple20WusbcpowerAdapter_internalRoleLinkName]))

WebUI.takeScreenshot(reportLocation + '/TC8/Step 9-Click on link productApple20WusbcpowerAdapter - Navigate to page product.png')
...
"Step 18: Click on link productApple20WusbcpowerAdapter -> Navigate to page 'product/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/category/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_category/link_productApple20WusbcpowerAdapter', ['class': link_productApple20WusbcpowerAdapter_class, 'internalRoleLinkName': link_productApple20WusbcpowerAdapter_internalRoleLinkName]))

WebUI.takeScreenshot(reportLocation + '/TC8/Step 18-Click on link productApple20WusbcpowerAdapter - Navigate to page product.png')
...
"Step 28: Click on link productApple20WusbcpowerAdapter -> Navigate to page 'product/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/category/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_category/link_productApple20WusbcpowerAdapter', ['class': link_productApple20WusbcpowerAdapter_class, 'internalRoleLinkName': link_productApple20WusbcpowerAdapter_internalRoleLinkName]))

WebUI.takeScreenshot(reportLocation + '/TC8/Step 28-Click on link productApple20WusbcpowerAdapter - Navigate to page product.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC8-Purchase Multiple Accessories and Manage Cart_visual_checkpoint')
