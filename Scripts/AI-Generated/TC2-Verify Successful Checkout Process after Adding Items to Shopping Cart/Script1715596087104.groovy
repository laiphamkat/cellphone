...
"Step 7: Enter shipping address details and complete payment"

enterShippingAddressDetailsAndCompletePayment.execute(data_path_0, Integer.valueOf(index_0))

"Step 8: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC2-Verify Successful Checkout Process after Adding Items to Shopping Cart_visual_checkpoint')
