...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_cart/link_goToCart'))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC10-Complete Order for Accessories with Email Subscription_visual_checkpoint')
