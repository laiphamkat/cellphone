...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 2-Click on link Apple.png')

"Step 3: Click on link New -> Navigate to page 'product#product/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'category/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_category/link_New'))

WebUI.takeScreenshot(reportLocation + '/TC2/Step 3-Click on link New - Navigate to page productproduct.png')
...
"Step 5: Click on div ColorOptions"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'product/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_product/div_ColorOptions'))

WebUI.takeScreenshot(reportLocation + '/TC2/Step 5-Click on div ColorOptions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 7-Click on input FirstName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 8-Enter input value in input FirstName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 9-Click on input LastName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 10-Enter input value in input LastName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 11-Click on input Address.png')
...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 12-Enter input value in input Address.png')
...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 13-Enter input value in input ZipCode.png')
...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 14-Click on input City.png')
...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 15-Enter input value in input City.png')
...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 16-Enter input value in input State.png')
...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 17-Click on input Phone.png')
...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 18-Enter input value in input Phone.png')

"Step 19: Click on button ContinueToPayment -> Navigate to page 'checkout#checkout/payment'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_checkout/button_ContinueToPayment'))

WebUI.takeScreenshot(reportLocation + '/TC2/Step 19-Click on button ContinueToPayment - Navigate to page checkoutcheckoutpayment.png')

"Step 20: Click on button CompleteOrder -> Navigate to page 'thank you#thank-you/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'checkout/payment?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_checkout/button_CompleteOrder'))

WebUI.takeScreenshot(reportLocation + '/TC2/Step 20-Click on button CompleteOrder - Navigate to page thank youthank-you.png')

"Step 21: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC2-Complete Purchase of New Apple Product with Selected Storage and Color_visual_checkpoint')
