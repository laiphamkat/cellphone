...
"Step 6: Proceed to checkout after entering email and shipping info"

WebUI.takeScreenshot()

proceedToCheckoutWithEmailAndShippingInfo.execute(data_path_0, Integer.valueOf(index_0))

"Step 7: Enter delivery and shipping address details for payment"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC7-Verify Successful Checkout Process for Accessories Category_visual_checkpoint')
