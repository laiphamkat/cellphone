...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 3-Click on link productCategories Apple3 - Navigate to page category.png')

"Step 4: Click on link productItems (20WUSBCPowerAdapter) -> Navigate to page 'product/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 4-Click on link productItems 20WUSBCPowerAdapter - Navigate to page product.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 5-Click on link cartNavigationMultiple GoToCart2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 7-Click on button CompleteOrder2 - Navigate to page .png')

"Step 8: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC9-Complete Order from Product Details to Home Page_visual_checkpoint')
