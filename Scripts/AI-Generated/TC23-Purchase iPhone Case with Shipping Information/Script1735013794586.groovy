...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 3-Click on link productCategories Apple3 - Navigate to page category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 4-Click on link iPhone15ClearCaseWithMagSafe - Navigate to page cart.png')
...
"Step 6: Enter email and shipping address details before payment"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC23-Purchase iPhone Case with Shipping Information_visual_checkpoint')
