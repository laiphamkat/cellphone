import katalon.common.subscribeEmailForShippingUpdates
...
"Step 25: Subscribe to email updates for shipping notifications"

subscribeEmailForShippingUpdates.execute(data_path_1, Integer.valueOf(index_1))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC6-Complex Purchase Flow for Multiple iPhone and Samsung Products_visual_checkpoint')
