...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 2: Click on link samsung - Navigate to page category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 3: Hover over item phone.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 4: Click on link phone.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 5: Click on link kcellphoneShop - Navigate to page .png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 6: Click on link iphoneSiliconeCaseWithMagsafe - Navigate to page product.png')

"Step 7: Hover over item phoneAppleSamsungGooglePixel"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/product/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.mouseOver(findTestObject('AI-Generated/Parameterized Objects/Page_product/item_phoneAppleSamsungGooglePixel'))

WebUI.takeScreenshot(reportLocation + '/TC8/Step 7: Hover over item phoneAppleSamsungGooglePixel.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 8: Click on link samsung - Navigate to page category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 9: Click on link samsungGalaxyS23UltraHot - Navigate to page product.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 10: Hover over item phoneAppleSamsungGooglePixel.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 11: Click on link phoneCategory - Navigate to page category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 12: Click on div object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 13: Click on link googlePixel7Pro - Navigate to page .png')

"Step 14: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC8-Browse and Verify Apple and Samsung Products_visual_checkpoint')
