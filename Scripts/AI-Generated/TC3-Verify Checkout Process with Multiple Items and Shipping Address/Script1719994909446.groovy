...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 2: Hover over item phone.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 4: Click on button newIphone15Plus.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 5: Click on button closeButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 7: Click on link goToCart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 8: Click on button proceedToCheckout - Navigate to page checkoutshipping-address.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 9: Hover over div muiInputBaseRoot.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 10: Click on input firstName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 11: Hover over div muiFormControlRoot.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 12: Enter input value in input firstName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 13: Click on input lastName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 14: Hover over div muiFormControlRoot.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 15: Enter input value in input lastName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 16: Click on input address.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 17: Hover over div muiFormControlRoot.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 18: Enter input value in input address.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 19: Click on input zipCode.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 20: Hover over div muiFormControlRoot.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 23: Enter input value in input city.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 24: Hover over div muiFormControlRoot.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 25: Enter input value in input state.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 26: Click on input shippingAddressPhone.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 27: Enter input value in input shippingAddressPhone.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 28: Click on button continueToPayment - Navigate to page thank-you.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 29: Hover over item accessoriesAppleSamsung.png')

"Step 30: Click on link apple -> Navigate to page 'category/*'"

//WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/thank-you/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_thank_you/link_apple'))

WebUI.takeScreenshot(reportLocation + '/TC3/Step 30: Click on link apple - Navigate to page category.png')

"Step 31: Hover over item phone"

//WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/category/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.mouseOver(findTestObject('AI-Generated/Page_category/item_phone'))

WebUI.takeScreenshot(reportLocation + '/TC3/Step 31: Hover over item phone.png')

"Step 32: Click on link samsung"

//WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/category/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_category/link_samsung'))

WebUI.takeScreenshot(reportLocation + '/TC3/Step 32: Click on link samsung.png')

"Step 33: Hover over item accessoriesAppleSamsung"

//WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/category/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.mouseOver(findTestObject('AI-Generated/Page_category/item_accessoriesAppleSamsung'))

WebUI.takeScreenshot(reportLocation + '/TC3/Step 33: Hover over item accessoriesAppleSamsung.png')

"Step 34: Click on link powerAndCables"

//WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/category/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_category/link_powerAndCables'))

WebUI.takeScreenshot(reportLocation + '/TC3/Step 34: Click on link powerAndCables.png')

"Step 35: Click on link accessories"

//WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/category/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_category/link_accessories'))

WebUI.takeScreenshot(reportLocation + '/TC3/Step 35: Click on link accessories.png')

"Step 36: Click on button sale20WusbcpowerAdapter"

//WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/category/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_category/button_sale20WusbcpowerAdapter'))

WebUI.takeScreenshot(reportLocation + '/TC3/Step 36: Click on button sale20WusbcpowerAdapter.png')

"Step 37: Click on link placeAnOrder -> Navigate to page '/cart'"

//WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/category/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_category/link_placeAnOrder'))

WebUI.takeScreenshot(reportLocation + '/TC3/Step 37: Click on link placeAnOrder - Navigate to page cart.png')

"Step 38: Click on button proceedToCheckout -> Navigate to page ''"

//WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/cart?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_cart/button_proceedToCheckout'))

WebUI.takeScreenshot(reportLocation + '/TC3/Step 38: Click on button proceedToCheckout - Navigate to page .png')

"Step 39: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC3-Verify Checkout Process with Multiple Items and Shipping Address_visual_checkpoint')
