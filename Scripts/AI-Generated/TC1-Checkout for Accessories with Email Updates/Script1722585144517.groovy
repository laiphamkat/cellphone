...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 3-Click on link categoryChekhlyNaIphone - Navigate to page category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 9-Click on button proceedToCheckout - Navigate to page checkout.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 10-Hover over div emailMeWithNews.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 14-Click on button completeOrder - Navigate to page .png')

"Step 15: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC1-Checkout for Accessories with Email Updates_visual_checkpoint')
