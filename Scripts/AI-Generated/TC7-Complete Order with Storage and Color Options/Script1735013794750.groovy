...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 2-Click on label storageOptions StorageCapacity.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 3-Click on label Color.png')

"Step 4: Enter email and shipping address details before payment"
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 5-Click on button CompleteOrder - Navigate to page thank-you.png')

"Step 6: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC7-Complete Order with Storage and Color Options_visual_checkpoint')
