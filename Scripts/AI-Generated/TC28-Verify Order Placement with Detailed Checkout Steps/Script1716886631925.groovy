...
WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_home/svg_hotNewBestChoiceiPhone'), 30)

WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_home/svg_hotNewBestChoiceiPhone'))

WebUI.takeScreenshot(reportLocation + '/TC28/Step 3: Click on svg.png')

"Step 4: Click on label"

WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_home/label_256Gb1'), 30)

WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_home/label_256Gb1'))

WebUI.takeScreenshot(reportLocation + '/TC28/Step 4: Click on label.png')

"Step 5: Click on label"

WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_home/label_naturalTitanium'), 30)

WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_home/label_naturalTitanium'))

WebUI.takeScreenshot(reportLocation + '/TC28/Step 5: Click on label.png')

"Step 6: Click on button 'Buy'"

WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_home/button_buy_1'), 30)
...
"Step 7: Click on svg  -> Navigate to page 'cart'"

WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_home/svg_placeAnOrder'), 30)

WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_home/svg_placeAnOrder'))

WebUI.takeScreenshot(reportLocation + '/TC28/Step 7: Click on svg  - Navigate to page cart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 8: Click on button .png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 9: Click on button Proceed to checkout - Navigate to page checkoutinfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 10: Click on input field email.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 11: Enter input value in input field email.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 12: Click on input field receive marketing info.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 13: Click on button CONTINUE TO SHIPPING.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 15: Click on input field payment method id.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 16: Click on button COMPLETE ORDER.png')
