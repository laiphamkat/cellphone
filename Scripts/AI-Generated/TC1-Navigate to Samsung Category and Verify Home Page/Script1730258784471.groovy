...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 5-Click on link ContactNumber - Navigate to page .png')

"Step 6: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC1-Navigate to Samsung Category and Verify Home Page_visual_checkpoint')
