...
WebUI.mouseOver(findTestObject('AI-Generated/Dynamic Objects/Page_home/item_phone_13'))

WebUI.takeScreenshot(reportLocation + '/TC19/Step 2-Hover over item phone.png')
...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 3-Click on link samsung - Navigate to page categorysamsung.png')
...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 4-Click on link byTitle.png')
...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 5-Click on link byPrice.png')
...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 6-Click on link googlePixel - Navigate to page categorygoogle-pixel.png')
...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 7-Click on link googlePixel8.png')

"Step 8: Choose product options and continue to checkout with email"

selectProductAndCheckout.execute(data_path_0, Integer.valueOf(index_0))

"Step 9: Input shipping details including name and address"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC19-Buy Google Pixel Phone with Shipping Information_visual_checkpoint')
