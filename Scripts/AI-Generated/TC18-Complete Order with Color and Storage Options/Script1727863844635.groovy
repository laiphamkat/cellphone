...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 3-Click on link mobileBrands Apple - Navigate to page category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 4-Click on label colorStorageOptions 512GB.png')

"Step 5: Click on label colorStorageOptions (Color)"
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 5-Click on label colorStorageOptions Color.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 6-Hover over link Cart - Navigate to page checkoutpayment.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 7-Click on button CompleteOrder - Navigate to page thank-you.png')

"Step 8: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC18-Complete Order with Color and Storage Options_visual_checkpoint')
