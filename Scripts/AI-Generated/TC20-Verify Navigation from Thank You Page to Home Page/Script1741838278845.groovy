...
WebUI.takeScreenshot(reportLocation + '/TC20/Step 3-Click on link Apple - Navigate to page .png')

"Step 4: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC20-Verify Navigation from Thank You Page to Home Page_visual_checkpoint')
