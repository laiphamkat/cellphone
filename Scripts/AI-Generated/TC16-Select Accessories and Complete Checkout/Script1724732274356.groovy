...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 3-Click on link samsung2 - Navigate to page categorypower-and-cables.png')
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_category_power_and_cables/link_samsungAccessories_1"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_category_power_and_cables/link_samsungAccessories_1', ['link_samsungAccessories_class': link_samsungAccessories_class, 'link_samsungAccessories_internalRoleHeadingName': link_samsungAccessories_internalRoleHeadingName]))

WebUI.takeScreenshot(reportLocation + '/TC16/Step 4-Click on link samsungAccessories samsungGalaxyS23UltraSmartviewCases - Navigate to page product.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 7-Click on link accessories - Navigate to page categoryaccessories.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 8-Click on link iphone15SiliconeCaseWithMagSafe - Navigate to page product.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 9-Click on label storageColorOptions 256Gb.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 10-Click on label storageColorOptions blueTitanium.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 16-Click on link cartNavigation goToCart - Navigate to page cart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 17-Click on button quantityAdjustment increased.png')
...
"Step 21: Complete shipping address form for order processing"
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 26-Click on button addToCart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 27-Click on button addToCart - Navigate to page .png')

"Step 28: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC16-Select Accessories and Complete Checkout_visual_checkpoint')
