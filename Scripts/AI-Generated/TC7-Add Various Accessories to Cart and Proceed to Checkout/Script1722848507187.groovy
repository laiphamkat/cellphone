...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 3-Click on link apple2 - Navigate to page category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 5-Click on button object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 6-Click on label iPhone15Plus.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 7-Click on label iPhone15Plus.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 8-Click on button buy2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 9-Click on link productApple20Wusbadapter - Navigate to page product.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 10-Click on label object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 11-Click on label object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 12-Click on button buy.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 13-Hover over item accessories.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 14-Click on link categoryChekhlyNaIphone - Navigate to page category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 15-Click on link categorySamsung.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 16-Click on link byTitle.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 17-Click on link byTitle.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 18-Click on link productApple20Wusbadapter - Navigate to page product.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 19-Click on label object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 20-Click on label object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 21-Click on button buy.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 22-Click on link placeAnOrder - Navigate to page cart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 23-Click on button removeButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 24-Hover over item listitem2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 26-Click on link byTitle.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 27-Click on link categorySamsung.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 28-Click on link productApple20Wusbadapter - Navigate to page product.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 29-Click on button buy.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 30-Click on link placeAnOrder - Navigate to page cart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 31-Click on button proceedToCheckout - Navigate to page .png')

"Step 32: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC7-Add Various Accessories to Cart and Proceed to Checkout_visual_checkpoint')
