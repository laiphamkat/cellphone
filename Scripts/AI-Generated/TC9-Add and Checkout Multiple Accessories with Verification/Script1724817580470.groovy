...
import katalon.common.completeShippingInformationAndContinueToShipping
...
"Step 15: Click on label colorOptions (256Gb)"
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 15-Click on label colorOptions 256Gb.png')

"Step 16: Click on label colorOptions (white)"
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 16-Click on label colorOptions white.png')
...
"Step 18: Click on button hotNewOffers (hotNewBestChoiceIphone)"
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 18-Click on button hotNewOffers hotNewBestChoiceIphone.png')

"Step 19: Click on label colorOptions (tb)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_home/label_colorOptions"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_home/label_colorOptions', ['label_colorOptions_for': label_colorOptions_for_2, 'label_colorOptions_internalText': label_colorOptions_internalText_2]))

WebUI.takeScreenshot(reportLocation + '/TC9/Step 19-Click on label colorOptions tb.png')

"Step 20: Click on label colorOptions (white)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_home/label_colorOptions"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_home/label_colorOptions', ['label_colorOptions_for': label_colorOptions_for_3, 'label_colorOptions_internalText': label_colorOptions_internalText_3]))

WebUI.takeScreenshot(reportLocation + '/TC9/Step 20-Click on label colorOptions white.png')
...
"Step 25: Complete shipping information and continue to shipping"

completeShippingInformationAndContinueToShipping.execute(data_path_1, Integer.valueOf(index_1))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC9-Add and Checkout Multiple Accessories with Verification_visual_checkpoint')
