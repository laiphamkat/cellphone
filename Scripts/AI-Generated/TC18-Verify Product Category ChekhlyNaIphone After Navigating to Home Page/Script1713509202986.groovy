...
"Step 4: Buy items from cart after selecting Apple products"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC18-Verify Product Category ChekhlyNaIphone After Navigating to Home Page_visual_checkpoint')
