import katalon.common.purchaseIPhone15PlusAndRelatedAccessories
...
purchaseIPhone15PlusAndRelatedAccessories.execute()
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC15-Verify Product Page for Samsung Galaxy Z Fold4 Silicon Cover_visual_checkpoint')
