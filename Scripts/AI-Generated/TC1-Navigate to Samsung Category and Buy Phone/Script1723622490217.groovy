...
WebUI.mouseOver(findTestObject('AI-Generated/Dynamic Objects/Page_home/item_phone_1'))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC1-Navigate to Samsung Category and Buy Phone_visual_checkpoint')
