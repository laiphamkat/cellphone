...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 3: Click on button proceedToCheckout - Navigate to page checkoutinfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 4: Hover over div emailMeWithNews.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 7: Click on button continueToShipping.png')

"Step 8: Input shipping information and delivery details"

inputShippingInformationAndDeliveryDetails.execute(data_path_0, Integer.valueOf(index_0))

"Step 9: Click on div deliveryInformationUs"
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 9: Click on div deliveryInformationUs.png')

"Step 10: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC3-Select Phone Proceed to Checkout and Input Shipping Information_visual_checkpoint')
