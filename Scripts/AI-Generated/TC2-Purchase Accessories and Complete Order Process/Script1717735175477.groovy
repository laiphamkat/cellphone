...
"Step 12: Click on span completeOrderButton"

WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/checkout/payment?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_checkout_payment/span_completeOrderButton'))

WebUI.takeScreenshot(reportLocation + '/TC2/Step 12: Click on span completeOrderButton.png')

"Step 13: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC2-Purchase Accessories and Complete Order Process_visual_checkpoint')
