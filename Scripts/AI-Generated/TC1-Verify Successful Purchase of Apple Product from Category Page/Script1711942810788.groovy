...
import katalon.common.clickAppleCategoryObjectLabelLabelAndBuyButton
...
clickAppleCategoryObjectLabelLabelAndBuyButton.execute(null, Integer.parseInt(1))
...
"Step 4: Click on svg  -> Navigate to page 'cart'"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC1-Verify Successful Purchase of Apple Product from Category Page_visual_checkpoint')
