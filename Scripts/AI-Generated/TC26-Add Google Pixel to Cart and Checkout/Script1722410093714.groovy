...
WebUI.takeScreenshot(reportLocation + '/TC26/Step 4: Click on link googlePixel7Pro - Navigate to page product.png')
...
WebUI.takeScreenshot(reportLocation + '/TC26/Step 5: Click on label 256Gb2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC26/Step 6: Click on label 256Gb2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC26/Step 7: Hover over div productsSlider.png')
...
WebUI.takeScreenshot(reportLocation + '/TC26/Step 8: Click on button addToCart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC26/Step 9: Click on label gb.png')
...
WebUI.takeScreenshot(reportLocation + '/TC26/Step 10: Click on label gb.png')
...
WebUI.takeScreenshot(reportLocation + '/TC26/Step 11: Click on button buy.png')

"Step 12: Click on link goToCart -> Navigate to page 'checkout/info'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/product/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_product/link_goToCart'))

WebUI.takeScreenshot(reportLocation + '/TC26/Step 12: Click on link goToCart - Navigate to page checkoutinfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC26/Step 13: Hover over div emailMeWithNews.png')
...
WebUI.takeScreenshot(reportLocation + '/TC26/Step 14: Click on input email.png')
...
WebUI.takeScreenshot(reportLocation + '/TC26/Step 15: Enter input value in input email.png')
...
WebUI.takeScreenshot(reportLocation + '/TC26/Step 16: Click on button continueToShipping - Navigate to page checkoutshipping-address.png')

"Step 17: Hover over div element"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.mouseOver(findTestObject('AI-Generated/Page_checkout_shipping_address/div_element'))

WebUI.takeScreenshot(reportLocation + '/TC26/Step 17: Hover over div element.png')

"Step 18: Click on input shippingAddressFirstName -> Navigate to page ''"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_checkout_shipping_address/input_shippingAddressFirstName'))

WebUI.takeScreenshot(reportLocation + '/TC26/Step 18: Click on input shippingAddressFirstName - Navigate to page .png')

"Step 19: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC26-Add Google Pixel to Cart and Checkout_visual_checkpoint')
