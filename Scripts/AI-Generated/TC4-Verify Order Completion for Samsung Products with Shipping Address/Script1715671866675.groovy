...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_category/label_cypress_1'))
...
"Step 13: Fill shipping address and complete order"

fillShippingAddressAndCompleteOrder.execute(data_path_0, Integer.valueOf(index_0))

"Step 14: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC4-Verify Order Completion for Samsung Products with Shipping Address_visual_checkpoint')
