...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 2-Hover over item object3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 3-Click on link productCategories Apple2 - Navigate to page category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 4-Click on button addToCartMultiple AddToCart2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 5-Click on label storageColorCapacity StorageCapacity.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 6-Click on label storageColorCapacity Yellow.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 7-Click on button Increased.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 8-Click on button purchaseOptions Decreased.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 9-Click on button purchaseOptions Buy.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 10-Hover over link GoToCart2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 11-Click on span dynamicObject 1 - Navigate to page cart.png')
...
"Step 13: Enter email and shipping address details before payment"
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 14-Click on button CompleteOrder - Navigate to page thank-you.png')

"Step 15: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC10-Add Multiple Items to Cart and Complete Order_visual_checkpoint')
