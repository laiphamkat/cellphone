...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 3-Click on label colorStorageOptions 512GB2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 4-Click on label colorStorageOptions Green.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 7-Click on link goToCart GoToCart2 - Navigate to page cart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 8-Click on button ProceedToCheckout - Navigate to page checkoutinfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 9-Hover over div CheckoutInfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 10-Click on input Email.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 11-Enter input value in input Email.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 12-Click on button ContinueToShipping - Navigate to page checkoutshipping-address.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 13-Hover over div CheckoutShippingAddress7.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 14-Click on input FirstName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 15-Hover over div CheckoutShippingAddress.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 16-Enter input value in input FirstName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 17-Click on input LastName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 18-Hover over div CheckoutShippingAddress2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 19-Enter input value in input LastName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 20-Click on input Address.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 21-Hover over div CheckoutShippingAddress3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 22-Enter input value in input Address.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 23-Click on input ZipCode.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 24-Hover over div CheckoutShippingAddress4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 25-Enter input value in input ZipCode.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 26-Click on input ShippingCity.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 27-Hover over div CheckoutShippingAddress5.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 28-Enter input value in input ShippingCity.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 29-Click on input State.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 30-Hover over div CheckoutShippingAddress6.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 31-Enter input value in input State.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 32-Click on input Phone.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 33-Enter input value in input Phone.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 34-Click on button ContinueToPayment.png')

"Step 35: Click on div ContinueToPayment -> Navigate to page 'checkout/payment'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_checkout_shipping_address/div_ContinueToPayment'))

WebUI.takeScreenshot(reportLocation + '/TC39/Step 35-Click on div ContinueToPayment - Navigate to page checkoutpayment.png')

"Step 36: Click on span CompleteOrder -> Navigate to page 'thank-you/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/checkout/payment?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_checkout_payment/span_CompleteOrder'))

WebUI.takeScreenshot(reportLocation + '/TC39/Step 36-Click on span CompleteOrder - Navigate to page thank-you.png')

"Step 37: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC39-Finalize Order for Multiple Products_visual_checkpoint')
