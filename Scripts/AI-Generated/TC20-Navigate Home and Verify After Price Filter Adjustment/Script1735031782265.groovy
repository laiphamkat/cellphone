...
WebUI.takeScreenshot(reportLocation + '/TC20/Step 3-Click on link productBrands Apple3 - Navigate to page category.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC20-Navigate Home and Verify After Price Filter Adjustment_visual_checkpoint')
