...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 3: Click on label 256Gb2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 4: Click on label yellow1.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 6: Click on link goToCart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 8: Click on button completeOrder - Navigate to page .png')

"Step 9: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC7-Verify Order Process for New iPhone 15 Plus_visual_checkpoint')
