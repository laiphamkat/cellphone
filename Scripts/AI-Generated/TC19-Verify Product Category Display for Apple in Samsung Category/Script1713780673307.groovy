...
"Step 4: Buy Apple products from the cart"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC19-Verify Product Category Display for Apple in Samsung Category_visual_checkpoint')
