...
import katalon.common.fillDeliveryAndShippingAddressDetails
import com.kms.katalon.core.model.FailureHandling
import internal.GlobalVariable
import static com.kms.katalon.core.testobject.ObjectRepository.findTestObject
import com.kms.katalon.core.webui.keyword.WebUiBuiltInKeywords as WebUI
import katalon.common.proceedCheckoutAndFillShippingInfo
...
"Step 7: Proceed to checkout and fill shipping info"

WebUI.takeScreenshot()

proceedCheckoutAndFillShippingInfo.execute(data_path_0, Integer.valueOf(index_0))

"Step 8: Fill delivery and shipping address details"

WebUI.takeScreenshot()

fillDeliveryAndShippingAddressDetails.execute(data_path_1, Integer.valueOf(index_1))

"Step 9: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC5-Verify Successful Order Completion after Buying_visual_checkpoint')
