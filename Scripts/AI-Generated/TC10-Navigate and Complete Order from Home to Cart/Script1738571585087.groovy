...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 3-Click on link brand Samsung - Navigate to page categorycategory.png')

"Step 4: Click on link productDetails (SamsungGalaxyS23UltraSmartviewCases) -> Navigate to page 'product#product/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 4-Click on link productDetails SamsungGalaxyS23UltraSmartviewCases - Navigate to page productproduct.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 5-Click on button action Increased.png')

"Step 6: Click on button action (Increased)"
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 6-Click on button action Increased.png')
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_product/button_action"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_product/button_action', ['button_action_internalRoleButtonName': button_action_internalRoleButtonName_2]))

WebUI.takeScreenshot(reportLocation + '/TC10/Step 7-Click on button action Increased.png')
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_product/button_action"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_product/button_action', ['button_action_internalRoleButtonName': button_action_internalRoleButtonName_3]))

WebUI.takeScreenshot(reportLocation + '/TC10/Step 8-Click on button action Buy.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 9-Click on link PlaceAnOrder.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC10-Navigate and Complete Order from Home to Cart_visual_checkpoint')
