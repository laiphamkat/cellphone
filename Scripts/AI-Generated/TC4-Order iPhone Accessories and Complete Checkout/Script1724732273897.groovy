...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 2-Hover over item productCategories accessories.png')
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_category_chekhly_na_iphone/link_iphoneAccessories_1"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_category_chekhly_na_iphone/link_iphoneAccessories_1', ['link_iphoneAccessories_class': link_iphoneAccessories_class, 'link_iphoneAccessories_internalRoleLinkName': link_iphoneAccessories_internalRoleLinkName]))

WebUI.takeScreenshot(reportLocation + '/TC4/Step 4-Click on link iphoneAccessories 20WusbtypeCadapter - Navigate to page product.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 6-Click on button increased2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 7-Hover over link cartNavigation goToCart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 8-Click on span cartIndicator shoppingCart - Navigate to page cart.png')
...
"Step 10: Fill in shipping information and continue to payment"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC4-Order iPhone Accessories and Complete Checkout_visual_checkpoint')
