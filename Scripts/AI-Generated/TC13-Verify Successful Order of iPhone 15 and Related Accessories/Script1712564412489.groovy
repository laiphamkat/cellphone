import katalon.common.addItemsToCartAndProceedToCheckout
...
"Step 4: Add items to cart and proceed to checkout"

WebUI.takeScreenshot()

addItemsToCartAndProceedToCheckout.execute()
...
"Step 14: Proceed through checkout process with shipping details"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC13-Verify Successful Order of iPhone 15 and Related Accessories_visual_checkpoint')
