...
"Step 5: Click on link brandCategories (Apple3) -> Navigate to page 'category/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 5-Click on link brandCategories Apple3 - Navigate to page category.png')

"Step 6: Click on link productDetails (productDetails) -> Navigate to page 'product/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 6-Click on link productDetails productDetails - Navigate to page product.png')
...
"Step 8: Click on label storageColorOptions (ProductName)"
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 8-Click on label storageColorOptions ProductName.png')

"Step 9: Click on label storageColorOptions (ColorCypress)"
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 9-Click on label storageColorOptions ColorCypress.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 10-Click on link cartNavigation GoToCart - Navigate to page checkoutinfo.png')

"Step 11: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC5-Verify Checkout Information for Selected Item_visual_checkpoint')
