...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 2: Hover over item item.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 3: Click on link apple.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 4: Click on button addToCartNewiPhone15Plus.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 5: Click on label 256Gb2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 7: Click on button buy.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 9: Click on button proceedToCheckout - Navigate to page checkoutpayment.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC16-Verify Checkout Process with New iPhone 15 Plus and Color Selection_visual_checkpoint')
