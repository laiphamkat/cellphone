...
import katalon.common.navigateToIPhoneCasesCategoryAndSetPriceRangeThenSearch
...
navigateToIPhoneCasesCategoryAndSetPriceRangeThenSearch.execute(data_path_0, Integer.valueOf(index_0))
...
proceedToCheckoutFillShippingAddressDetailsAndContinueToPayment.execute(data_path_1, Integer.valueOf(index_1))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC7-Verify Payment Confirmation for Checkout Process_visual_checkpoint')
