...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 4-Click on button addToCart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 8-Click on link cart - Navigate to page cart.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC4-Add to Cart and Complete Order for Apple Device with 512GB_visual_checkpoint')
