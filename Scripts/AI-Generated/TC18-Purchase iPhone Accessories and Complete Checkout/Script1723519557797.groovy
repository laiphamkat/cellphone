...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 2-Hover over item accessories.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 3-Click on link apple - Navigate to page categorychekhly-na-iphone.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 4-Click on link byPrice.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 5-Click on button addToCartNewIphone15SiliconeCase.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 6-Click on label iPhone15Plus.png')

"Step 7: Click on label cypress"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/category/chekhly-na-iphone?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_category_chekhly_na_iphone/label_cypress_3"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_category_chekhly_na_iphone/label_cypress_3', ['label_cypress_for': label_cypress_for, 'label_cypress_internalText': label_cypress_internalText]))

WebUI.takeScreenshot(reportLocation + '/TC18/Step 7-Click on label cypress.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 8-Click on button dialogButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 9-Click on link samsung - Navigate to page categorypower-and-cables.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 10-Click on link byTitle.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 11-Click on button addToCart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 12-Click on link placeAnOrder - Navigate to page cart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 14-Click on button increased.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 15-Click on button proceedToCheckout - Navigate to page checkoutinfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 16-Hover over div emailMeWithNews.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 17-Click on input email.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 18-Enter input value in input email.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 19-Click on button continueToShipping.png')

"Step 20: Input shipping details including name and address"
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 21-Click on button completeOrder - Navigate to page .png')

"Step 22: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC18-Purchase iPhone Accessories and Complete Checkout_visual_checkpoint')
