...
WebUI.takeScreenshot(reportLocation + '/TC17/Step 9-Click on label colorStorageOptions 256Gb.png')

"Step 10: Click on label colorStorageOptions (blueTitanium)"
...
WebUI.takeScreenshot(reportLocation + '/TC17/Step 10-Click on label colorStorageOptions blueTitanium.png')
...
"Step 21: Complete shipping information and continue to shipping"

completeShippingInformationAndContinueToShipping.execute(data_path_0, Integer.valueOf(index_0))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC17-Add Samsung and iPhone Accessories to Cart and Checkout_visual_checkpoint')
