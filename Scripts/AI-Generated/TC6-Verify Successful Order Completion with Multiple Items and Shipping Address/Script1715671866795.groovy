...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_category/link_samsung_1'))
...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_category/button_samsungGalaxyS23Ultra_1'))
...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_category/label_cypress_2'))
...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_category/label_iPhone15Plus_1'))

WebUI.takeScreenshot()

"Step 20: Select items, proceed to checkout, and continue to shipping"

selectItemsProceedToCheckoutAndContinueToShipping.execute(data_path_1, Integer.valueOf(index_1))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC6-Verify Successful Order Completion with Multiple Items and Shipping Address_visual_checkpoint')
