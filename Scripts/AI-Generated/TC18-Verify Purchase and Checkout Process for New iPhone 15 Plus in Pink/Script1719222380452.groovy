...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 3: Click on link apple.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 4: Click on button addToCartNewiPhone15Plus.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 5: Click on label 256Gb2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 6: Click on label pink.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 7: Click on button buy.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 8: Click on link goToCart - Navigate to page cart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 9: Click on button proceedToCheckout - Navigate to page checkoutpayment.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC18-Verify Purchase and Checkout Process for New iPhone 15 Plus in Pink_visual_checkpoint')
