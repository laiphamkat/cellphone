...
"Step 3: Click on link brandAndAccessories (samsung) -> Navigate to page 'category/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 3-Click on link brandAndAccessories samsung - Navigate to page category.png')
...
"Step 5: Click on label colorAndStorageOptions (512Gb2)"
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 5-Click on label colorAndStorageOptions 512Gb2.png')

"Step 6: Click on label colorAndStorageOptions (blue)"
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 6-Click on label colorAndStorageOptions blue.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 10-Click on input email - Navigate to page thank-you.png')

"Step 11: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC7-Checkout Process with Shipping Information and Thank You Verification_visual_checkpoint')
