...
import katalon.common.selectAccessoriesByPriceAndProceedToCheckout
...
selectAccessoriesByPriceAndProceedToCheckout.execute(null, Integer.parseInt(1))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC2-Verify Successful Checkout Process for Selected Accessories_visual_checkpoint')
