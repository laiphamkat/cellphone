...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 2-Click on link GooglePixel - Navigate to page product category page.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 3-Click on link GooglePixel7Pro - Navigate to page productproduct.png')

"Step 4: Click on button purchaseQuantity (Buy3)"
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 4-Click on button purchaseQuantity Buy3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 5-Click on button purchaseQuantity Buy2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 6-Click on link PlaceOrder - Navigate to page cartcart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 10-Click on button CompleteOrder - Navigate to page .png')

"Step 11: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC16-Order Google Pixel 7 Pro with Multiple Quantities_visual_checkpoint')
