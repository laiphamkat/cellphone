...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_home/label_512Gb_1"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_home/label_512Gb_1', ['label_512Gb_for': label_512Gb_1_label_512Gb_for, 'label_512Gb_internalText': label_512Gb_1_label_512Gb_internalText]))
...
"Step 6: Select product options and navigate to checkout page"

selectProductAndProceedToCheckout.execute(data_path_0, Integer.valueOf(index_0))

"Step 7: Input shipping information and proceed to payment"

fillShippingDetailsAndContinue.execute(data_path_1, Integer.valueOf(index_1))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC4-Purchase New iPhone 15 Plus with Shipping Information_visual_checkpoint')
