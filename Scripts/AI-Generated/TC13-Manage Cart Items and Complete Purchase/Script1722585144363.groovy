...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_category/link_byTitle'))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC13-Manage Cart Items and Complete Purchase_visual_checkpoint')
