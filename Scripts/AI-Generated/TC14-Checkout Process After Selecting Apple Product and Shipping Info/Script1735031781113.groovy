...
import truetest.common.completeCheckoutProcessWithEmail
...
"Step 4: Enter email and fill shipping address to proceed to payment."

completeCheckoutProcessWithEmail.execute(data_path_0, Integer.valueOf(index_0))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC14-Checkout Process After Selecting Apple Product and Shipping Info_visual_checkpoint')
