...
import katalon.common.searchPhonesByPrice
...
searchPhonesByPrice.execute(data_path_0, Integer.valueOf(index_0))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC11-Verify Successful Purchase of iPhone 15 from Phone Category_visual_checkpoint')
