...
WebUI.takeScreenshot(reportLocation + '/TC60/Step 2-Hover over item object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC60/Step 3-Click on link Apple - Navigate to page categoryapple.png')

"Step 4: Click on button AddToCart2"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/category/apple?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_category_apple/button_AddToCart2'))

WebUI.takeScreenshot(reportLocation + '/TC60/Step 4-Click on button AddToCart2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC60/Step 5-Click on label storageColorOption Storage512GB.png')
...
WebUI.takeScreenshot(reportLocation + '/TC60/Step 6-Click on label storageColorOption ColorYellow.png')

"Step 7: Click on button Increased2"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/category/apple?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_category_apple/button_Increased2'))

WebUI.takeScreenshot(reportLocation + '/TC60/Step 7-Click on button Increased2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC60/Step 8-Click on button quantityControl Decreased.png')
...
WebUI.takeScreenshot(reportLocation + '/TC60/Step 9-Click on button quantityControl Buy.png')
...
WebUI.takeScreenshot(reportLocation + '/TC60/Step 10-Hover over link GoToCart.png')

"Step 11: Click on span dynamicObject (Link2)"
...
WebUI.takeScreenshot(reportLocation + '/TC60/Step 11-Click on span dynamicObject Link2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC60/Step 13-Click on button CompleteOrder - Navigate to page thank-you.png')

"Step 14: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC60-Add Apple Product to Cart and Complete Order with Quantity Adjustment_visual_checkpoint')
