...
import katalon.common.selectAccessoriesByPriceAndPlaceAnOrder
...
selectAccessoriesByPriceAndPlaceAnOrder.execute(null, Integer.parseInt(1))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC12-Verify Successful Checkout Process for Selected Accessories_visual_checkpoint')
