...
"Step 6: Click on link 'iPhone 15'"
...
"Step 7: Buy items and place an order"

WebUI.takeScreenshot()

buyItemsAndPlaceOrder.execute()

"Step 8: Proceed to checkout after providing email and shipping info"

WebUI.takeScreenshot()

proceedToCheckoutWithEmailAndShippingInfo.execute(data_path_0, Integer.valueOf(index_0))

"Step 9: Enter shipping details and continue to payment"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC15-Verify Successful Order Completion with Checkout_visual_checkpoint')
