...
WebUI.takeScreenshot(reportLocation + '/TC15/Step 3: Click on link goToCart - Navigate to page .png')

"Step 4: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC15-Browse Category and Verify Home Page_visual_checkpoint')
