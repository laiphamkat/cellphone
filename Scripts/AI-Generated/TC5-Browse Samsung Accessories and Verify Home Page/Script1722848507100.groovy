...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 6-Click on button closeButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 7-Click on link productApple20Wusbadapter - Navigate to page product.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 8-Hover over item accessories.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 9-Click on link categoryChekhlyNaIphone - Navigate to page category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 10-Click on link productApple20Wusbadapter - Navigate to page product.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 11-Hover over item accessories.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 12-Click on link categoryChekhlyNaIphone - Navigate to page category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 13-Click on link categorySamsung.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 14-Click on link categorySamsung.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC5-Browse Samsung Accessories and Verify Home Page_visual_checkpoint')
