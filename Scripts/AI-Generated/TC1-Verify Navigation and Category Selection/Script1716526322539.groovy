...
WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_home/item_item'), 30)

WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.mouseOver(findTestObject('AI-Generated/Page_home/item_item'))

WebUI.takeScreenshot(reportLocation + '/TC1/Step 3: Hover over list item.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC1-Verify Navigation and Category Selection_visual_checkpoint')
