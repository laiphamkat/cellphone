...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 3-Click on button purchaseActions Increased.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 4-Click on label storageColorOptions Storage256GB.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 5-Click on label storageColorOptions ColorSelection.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 6-Click on button purchaseActions Buy.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 7-Hover over link CartNavigation.png')

"Step 8: Click on span additionalLinks (Link2) -> Navigate to page '/cart'"
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 8-Click on span additionalLinks Link2 - Navigate to page cart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 10-Click on button ProceedToCheckout - Navigate to page checkoutinfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 11-Hover over div CheckoutInfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 12-Click on input Email.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 13-Enter input value in input Email.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 14-Click on button ContinueToShipping - Navigate to page checkoutshipping-address.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 15-Hover over div CheckoutShippingAddress.png')

"Step 16: Fill in shipping address details during checkout"

fillShippingAddressDetails.execute(data_path_0, Integer.valueOf(index_0))

"Step 17: Complete shipping information and proceed to payment"
