...
WebUI.takeScreenshot(reportLocation + '/TC27/Step 2-Hover over item object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC27/Step 3-Click on link mobileBrands GooglePixel - Navigate to page category pagecategory.png')
...
WebUI.takeScreenshot(reportLocation + '/TC27/Step 4-Click on button addToCart AddToCart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC27/Step 5-Hover over link GoToCart2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC27/Step 6-Click on span dynamicObject Link1 - Navigate to page cart pagecart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC27/Step 7-Click on div PriceQtyTotal.png')
...
WebUI.takeScreenshot(reportLocation + '/TC27/Step 8-Click on div PriceQtyTotal.png')
...
WebUI.takeScreenshot(reportLocation + '/TC27/Step 10-Click on button CompleteOrder - Navigate to page .png')

"Step 11: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC27-Add Mobile Phone to Cart and Complete Checkout Process_visual_checkpoint')
