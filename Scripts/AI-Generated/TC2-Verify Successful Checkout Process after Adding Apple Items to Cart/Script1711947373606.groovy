...
import katalon.common.clickAppleCategoryObjectLabelButtonBuy
...
clickAppleCategoryObjectLabelButtonBuy.execute(null, Integer.parseInt(1))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC2-Verify Successful Checkout Process after Adding Apple Items to Cart_visual_checkpoint')
