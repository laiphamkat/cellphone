...
"Step 2: Click on link brand (Samsung2) -> Navigate to page 'category#category/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 2-Click on link brand Samsung2 - Navigate to page categorycategory.png')

"Step 3: Click on link productDetails (SamsungGalaxyS23Ultra) -> Navigate to page 'product#product/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 3-Click on link productDetails SamsungGalaxyS23Ultra - Navigate to page productproduct.png')

"Step 4: Click on label colorStorageOption (TB)"
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 4-Click on label colorStorageOption TB.png')

"Step 5: Click on label colorStorageOption (White)"
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 5-Click on label colorStorageOption White.png')

"Step 6: Click on label colorStorageOption (Black)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'product/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_product/label_colorStorageOption"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_product/label_colorStorageOption', ['label_colorStorageOption_for': label_colorStorageOption_for_2, 'label_colorStorageOption_internalText': label_colorStorageOption_internalText_2]))

WebUI.takeScreenshot(reportLocation + '/TC9/Step 6-Click on label colorStorageOption Black.png')

"Step 7: Click on label colorStorageOption (256GB)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'product/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_product/label_colorStorageOption"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_product/label_colorStorageOption', ['label_colorStorageOption_for': label_colorStorageOption_for_3, 'label_colorStorageOption_internalText': label_colorStorageOption_internalText_3]))

WebUI.takeScreenshot(reportLocation + '/TC9/Step 7-Click on label colorStorageOption 256GB.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 8-Click on button purchaseAction Buy.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 10-Click on button purchaseAction Buy.png')

"Step 11: Click on link PlaceAnOrder"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'product/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_product/link_PlaceAnOrder'))

WebUI.takeScreenshot(reportLocation + '/TC9/Step 11-Click on link PlaceAnOrder.png')

"Step 12: Proceed to checkout and fill in shipping information"

proceedToCheckoutAndEnterShippingInfo.execute(data_path_0, Integer.valueOf(index_0))

"Step 13: Click on button CompleteOrder -> Navigate to page 'thank you#thank-you/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'checkout/payment?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_checkout/button_CompleteOrder'))

WebUI.takeScreenshot(reportLocation + '/TC9/Step 13-Click on button CompleteOrder - Navigate to page thank youthank-you.png')

"Step 14: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC9-Purchase iPhone 15 Pro with Multiple Options_visual_checkpoint')
