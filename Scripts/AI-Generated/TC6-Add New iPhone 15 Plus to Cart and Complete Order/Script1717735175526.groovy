...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 3: Click on link apple.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 4: Click on button addToCartNewiPhone15Plus.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 5: Click on label 256Gb2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 6: Click on label pink.png')
...
"Step 8: Click on link 3 -> Navigate to page 'cart'"

WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_home/link_3'))

WebUI.takeScreenshot(reportLocation + '/TC6/Step 8: Click on link 3 - Navigate to page cart.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC6-Add New iPhone 15 Plus to Cart and Complete Order_visual_checkpoint')
