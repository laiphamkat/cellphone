...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 3-Click on link mobileBrands Apple - Navigate to page category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 7-Enter input value in input City.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 8-Click on input State.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 9-Hover over div CheckoutShippingAddress2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 10-Enter input value in input State.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 11-Click on input Phone.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 12-Enter input value in input Phone.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 13-Click on button ContinueToPayment - Navigate to page checkoutpayment.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 14-Click on button CompleteOrder - Navigate to page .png')

"Step 15: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC4-Add Product to Cart and Complete Checkout with Shipping Details_visual_checkpoint')
