...
import katalon.common.browseAccessoriesAndAddItemsToCart
...
"Step 2: Browse accessories and add items to the cart for purchase"

browseAccessoriesAndAddItemsToCart.execute(data_path_0, Integer.valueOf(index_0))
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 3-Click on label 512Gb.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 6-Click on label iPhone15Plus.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 7-Click on label iPhone15Plus.png')
...
WebUI.mouseOver(findTestObject('AI-Generated/Dynamic Objects/Page_cart/link_goToCart'))

WebUI.takeScreenshot(reportLocation + '/TC9/Step 9-Hover over link goToCart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 10-Click on span object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 11-Hover over link goToCart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 14-Click on button addToCartSamsungGalaxyS23.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 15-Click on label 256Gb.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 16-Click on label 256Gb.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 17-Click on button closeButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 18-Click on button hotNewiPhone15.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 19-Click on label 256Gb.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 20-Click on label 256Gb.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 23-Click on span shoppingCart - Navigate to page cart.png')
...
"Step 25: Subscribe to email updates and proceed to shipping"

subscribeToEmailUpdatesAndContinueToShipping.execute(data_path_1, Integer.valueOf(index_1))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC9-Add Accessories and Complete Checkout Process_visual_checkpoint')
