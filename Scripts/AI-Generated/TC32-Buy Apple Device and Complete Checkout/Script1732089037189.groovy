...
WebUI.takeScreenshot(reportLocation + '/TC32/Step 3-Click on link Apple - Navigate to page category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC32/Step 4-Click on button addToCart AddToCart2.png')

"Step 5: Click on label colorStorageOptions (Storage512GB2)"
...
WebUI.takeScreenshot(reportLocation + '/TC32/Step 5-Click on label colorStorageOptions Storage512GB2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC32/Step 6-Click on label colorStorageOptions Green2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC32/Step 8-Click on link GoToCart2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC32/Step 10-Click on button CompleteOrder - Navigate to page .png')

"Step 11: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC32-Buy Apple Device and Complete Checkout_visual_checkpoint')
