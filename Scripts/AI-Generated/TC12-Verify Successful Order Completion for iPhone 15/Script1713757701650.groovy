...
import katalon.common.enterDeliveryAndShippingAddressForPayment
import katalon.common.selectAndBuyItemsToPlaceOrder
...
"Step 4: Select and buy items to place an order"

WebUI.takeScreenshot()

selectAndBuyItemsToPlaceOrder.execute()

"Step 5: Proceed to checkout after entering email and shipping info"

WebUI.takeScreenshot()

proceedToCheckoutWithEmailAndShippingInfo.execute(data_path_0, Integer.valueOf(index_0))

"Step 6: Enter delivery and shipping address details for payment"

WebUI.takeScreenshot()

enterDeliveryAndShippingAddressForPayment.execute(data_path_1, Integer.valueOf(index_1))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC12-Verify Successful Order Completion for iPhone 15_visual_checkpoint')
