...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 3-Click on link Apple - Navigate to page iphone cases category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 4-Click on link Sale.png')
...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 5-Click on link NewyorkAccount - Navigate to page productproduct.png')

"Step 6: Click on button buyQuantity (Buy3)"
...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 6-Click on button buyQuantity Buy3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 7-Click on link PlaceOrder - Navigate to page cartcart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 8-Click on button proceedToCheckout ProceedToCheckout.png')

"Step 9: Click on button proceedToCheckout (ProceedToCheckout2) -> Navigate to page 'checkout info#checkout/info'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'cart?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_cart/button_proceedToCheckout"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_cart/button_proceedToCheckout', ['button_proceedToCheckout_internalRoleButtonName': button_proceedToCheckout_internalRoleButtonName_1]))

WebUI.takeScreenshot(reportLocation + '/TC19/Step 9-Click on button proceedToCheckout ProceedToCheckout2 - Navigate to page checkout infocheckoutinfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 10-Hover over div checkoutInfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 11-Click on input Email.png')
...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 12-Enter input value in input Email.png')

"Step 13: Enter input value in input EmailAddress"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'checkout/info?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.setText(findTestObject('AI-Generated/Page_checkout_info/input_EmailAddress'), input_EmailAddress)

WebUI.takeScreenshot(reportLocation + '/TC19/Step 13-Enter input value in input EmailAddress.png')
...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 14-Click on button ContinueToShipping - Navigate to page checkoutcheckoutshipping-address.png')
...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 15-Hover over div checkout.png')
...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 16-Click on input FirstName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 17-Enter input value in input FirstName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 18-Hover over div checkout2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 19-Click on input LastName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 20-Enter input value in input LastName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 21-Hover over div checkout3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 22-Click on input Address.png')
...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 23-Enter input value in input Address.png')
...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 24-Hover over div checkout.png')
...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 25-Click on input FirstName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 26-Enter input value in input FirstName.png')

"Step 27: Hover over div checkout7"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.mouseOver(findTestObject('AI-Generated/Page_checkout/div_checkout7'))

WebUI.takeScreenshot(reportLocation + '/TC19/Step 27-Hover over div checkout7.png')
...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 28-Click on input ZipCode.png')
...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 29-Enter input value in input ZipCode.png')

"Step 30: Hover over div checkout4"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.mouseOver(findTestObject('AI-Generated/Page_checkout/div_checkout4'))

WebUI.takeScreenshot(reportLocation + '/TC19/Step 30-Hover over div checkout4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 31-Click on input City.png')
...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 32-Enter input value in input City.png')

"Step 33: Hover over div checkout5"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.mouseOver(findTestObject('AI-Generated/Page_checkout/div_checkout5'))

WebUI.takeScreenshot(reportLocation + '/TC19/Step 33-Hover over div checkout5.png')
...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 34-Click on input State.png')
...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 35-Enter input value in input State.png')

"Step 36: Hover over div checkout6"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.mouseOver(findTestObject('AI-Generated/Page_checkout/div_checkout6'))

WebUI.takeScreenshot(reportLocation + '/TC19/Step 36-Hover over div checkout6.png')
...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 37-Click on input Phone.png')
...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 39-Click on button ContinueToPayment - Navigate to page .png')

"Step 40: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC19-Complete Order for iPhone Accessories with Detailed Checkout_visual_checkpoint')
