...
"Step 11: Fill shipping address and complete order"

fillShippingAddressAndCompleteOrder.execute(data_path_0, Integer.valueOf(index_0))

"Step 12: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC5-Verify Order Completion Process from Cart to Thank You Page for Google Pixel_visual_checkpoint')
