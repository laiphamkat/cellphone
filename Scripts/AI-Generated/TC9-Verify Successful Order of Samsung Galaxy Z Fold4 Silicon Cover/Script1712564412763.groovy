...
import katalon.common.searchAccessoriesByPriceRange
...
"Step 2: Search for accessories within specified price range"

WebUI.takeScreenshot()

searchAccessoriesByPriceRange.execute(data_path_0, Integer.valueOf(index_0))
...
"Step 7: Proceed through checkout process with shipping details"

WebUI.takeScreenshot()

proceedCheckoutWithShippingDetails.execute(data_path_1, Integer.valueOf(index_1))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC9-Verify Successful Order of Samsung Galaxy Z Fold4 Silicon Cover_visual_checkpoint')
