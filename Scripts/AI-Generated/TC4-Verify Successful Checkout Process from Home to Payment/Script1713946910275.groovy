...
"Step 2: Hover over list item  -> Navigate to page 'category/chekhly-na-iphone'"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC4-Verify Successful Checkout Process from Home to Payment_visual_checkpoint')
