...
"Step 6: Click on button Show1"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'category/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_category/button_Show1'))

WebUI.takeScreenshot(reportLocation + '/TC2/Step 6-Click on button Show1.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC2-Add Products to Cart and Checkout from Home_visual_checkpoint')
