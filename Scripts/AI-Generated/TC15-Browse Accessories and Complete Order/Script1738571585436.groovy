...
WebUI.takeScreenshot(reportLocation + '/TC15/Step 2-Click on link brand Samsung - Navigate to page categorycategory.png')
...
WebUI.takeScreenshot(reportLocation + '/TC15/Step 3-Click on link productDetails SamsungGalaxyS23UltraSmartviewCases - Navigate to page productproduct.png')
...
WebUI.takeScreenshot(reportLocation + '/TC15/Step 4-Click on button action Buy.png')
...
WebUI.takeScreenshot(reportLocation + '/TC15/Step 5-Click on link Accessories - Navigate to page categorycategory.png')
...
WebUI.takeScreenshot(reportLocation + '/TC15/Step 6-Click on link brand Samsung.png')
...
WebUI.takeScreenshot(reportLocation + '/TC15/Step 7-Click on link productDetails SamsungGalaxyS23UltraSmartviewCases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC15/Step 9-Click on link PlaceAnOrder.png')
...
WebUI.takeScreenshot(reportLocation + '/TC15/Step 11-Click on button CompleteOrder - Navigate to page thank youthank-you.png')

"Step 12: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC15-Browse Accessories and Complete Order_visual_checkpoint')
