...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 3-Click on link productBrands Samsung - Navigate to page category.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC2-Navigate to Home and Verify Page After Category Selection_visual_checkpoint')
