...
WebUI.mouseOver(findTestObject('AI-Generated/Dynamic Objects/Page_home/item_phone_8'))
...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 3-Click on link accessories - Navigate to page categoryaccessories.png')
...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 4-Click on button sale20WusbpowerAdapter.png')
...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 5-Click on link placeAnOrder - Navigate to page cart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 6-Click on button proceedToCheckout - Navigate to page checkoutinfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 7-Hover over div emailMeWithNews.png')
...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 10-Click on div continueToShipping - Navigate to page .png')

"Step 11: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC2-Purchase 20W USB Power Adapter and Verify Home Page_visual_checkpoint')
