...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 4-Click on label productAttributes ProductStorage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 5-Click on label productAttributes ProductColor.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC8-Purchase iPhone 15 and Complete Checkout_visual_checkpoint')
