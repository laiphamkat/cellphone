...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 4: Click on link iPhone15HotNew - Navigate to page product.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 5: Click on list horizontalMenuList.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 6: Click on button plus.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 7: Click on label 256Gb.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 8: Click on label 256Gb.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 9: Click on button plus.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 10: Click on button plus.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 11: Click on link goToCart - Navigate to page cart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 12: Click on button proceedToCheckout - Navigate to page checkoutinfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 16: Click on link backToTheCart - Navigate to page cart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 17: Hover over item phone.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 18: Click on link apple2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 19: Click on link apple2 - Navigate to page category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 20: Click on button newiPhone15Plus.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 21: Click on button newiPhone15Plus.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 22: Click on label 1Tb.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 23: Click on label 1Tb.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 24: Click on label 1Tb.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 25: Click on label 1Tb.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 26: Click on button buy2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 27: Click on button buy2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 28: Click on link goToCart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 29: Click on link goToCart - Navigate to page cart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 30: Click on button proceedToCheckout.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 31: Click on button proceedToCheckout - Navigate to page checkoutinfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 32: Hover over div emailMeWithNews.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 33: Click on input email.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 34: Enter input value in input email.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 35: Click on button continueToShipping - Navigate to page .png')

"Step 36: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC10-Complex Checkout Process with Multiple Items_visual_checkpoint')
