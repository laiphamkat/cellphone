...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 2-Hover over item dynamicObject item2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 4-Click on link mobileDevices samsungGalaxyZfold5 - Navigate to page product.png')
...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 5-Click on label colorModelStorage 512Gb.png')

"Step 6: Click on label colorModelStorage (blue)"
...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 6-Click on label colorModelStorage blue.png')
...
"Step 8: Hover over link goToCart (goToCart)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/product/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.mouseOver(findTestObject('AI-Generated/Page_product/link_goToCart'))

WebUI.takeScreenshot(reportLocation + '/TC2/Step 8-Hover over link goToCart goToCart.png')

"Step 9: Click on span shoppingCart (shoppingCart) -> Navigate to page '/cart'"
...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 9-Click on span shoppingCart shoppingCart - Navigate to page cart.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC2-Purchase Samsung Mobile Device and Verify Checkout_visual_checkpoint')
