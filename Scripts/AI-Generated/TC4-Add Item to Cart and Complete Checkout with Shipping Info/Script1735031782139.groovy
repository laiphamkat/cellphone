...
"Step 3: Click on link productBrands (Samsung) -> Navigate to page 'category/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 3-Click on link productBrands Samsung - Navigate to page category.png')
...
"Step 8: Complete shipping address form after entering email and continue to payment."
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC4-Add Item to Cart and Complete Checkout with Shipping Info_visual_checkpoint')
