import katalon.common.buyItemsProceedToCheckoutAndFillShippingAddress
...
"Step 20: Buy items, proceed to checkout, and fill shipping address"

buyItemsProceedToCheckoutAndFillShippingAddress.execute(data_path_1, Integer.valueOf(index_1))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC8-Verify Order Completion Process with Multiple Items and Shipping Address_visual_checkpoint')
