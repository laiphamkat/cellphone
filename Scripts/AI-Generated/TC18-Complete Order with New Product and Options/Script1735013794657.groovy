...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 2-Hover over item object3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 3-Click on link productCategories Apple2 - Navigate to page category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 4-Click on button newProduct newProduct.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 5-Click on label storageColorCapacity StorageCapacity.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 6-Click on label storageColorCapacity Green2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 7-Click on button Increased2.png')

"Step 8: Click on button Buy2"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/category/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_category/button_purchaseOptions'))

WebUI.takeScreenshot(reportLocation + '/TC18/Step 8-Click on button Buy2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 9-Click on link PlaceOrder - Navigate to page cart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 10-Click on link GoToCart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 11-Click on button ProceedToCheckout2.png')

"Step 12: Enter email and shipping address details before payment"
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 13-Click on button CompleteOrder - Navigate to page thank-you.png')

"Step 14: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC18-Complete Order with New Product and Options_visual_checkpoint')
