...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 13-Click on button quantityAdjustment IncreaseQuantity2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 14-Click on button quantityAdjustment IncreaseQuantity2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 15-Click on button quantityAdjustment IncreaseQuantity2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 16-Click on button quantityAdjustment IncreaseQuantity2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 19-Click on input FirstName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 21-Enter input value in input FirstName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 22-Click on input LastName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 24-Enter input value in input LastName2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 25-Click on input Address.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 27-Enter input value in input Address2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 28-Click on input ZipCode.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 30-Enter input value in input ZipCode2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 31-Click on input City.png')
...
"Step 33: Enter input value in input City2"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.setText(findTestObject('AI-Generated/Page_checkout_shipping_address/input_City'), input_City2)

WebUI.takeScreenshot(reportLocation + '/TC18/Step 33-Enter input value in input City2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 34-Click on input State.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 36-Click on input Phone.png')

"Step 37: Enter input value in input State2"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.setText(findTestObject('AI-Generated/Page_checkout_shipping_address/input_State'), input_State2)

WebUI.takeScreenshot(reportLocation + '/TC18/Step 37-Enter input value in input State2.png')

"Step 38: Enter input value in input Phone2"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.setText(findTestObject('AI-Generated/Page_checkout_shipping_address/input_Phone'), input_Phone2)

WebUI.takeScreenshot(reportLocation + '/TC18/Step 38-Enter input value in input Phone2.png')
