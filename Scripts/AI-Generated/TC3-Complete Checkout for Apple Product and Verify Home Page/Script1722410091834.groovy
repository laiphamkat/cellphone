...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 4: Click on button sale20WusbtypeCadapter.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 6: Click on button proceedToCheckout - Navigate to page checkoutinfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 7: Hover over div emailMeWithNews.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 10: Click on button continueToShipping.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 12: Click on button completeOrder - Navigate to page .png')

"Step 13: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC3-Complete Checkout for Apple Product and Verify Home Page_visual_checkpoint')
