...
import katalon.common.browseAndOrderIphone15PlusWithAccessories
...
"Step 17: Browse and order iPhone 15 plus and related accessories"

WebUI.takeScreenshot()

browseAndOrderIphone15PlusWithAccessories.execute()
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC17-Verify Product Details and Ordering Process for Samsung Products_visual_checkpoint')
