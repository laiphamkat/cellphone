...
WebUI.takeScreenshot(reportLocation + '/TC74/Step 2-Hover over item object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC74/Step 3-Click on link Apple - Navigate to page display list of itemsfixed partitem main or descendent item category id or slug.png')

"Step 4: Click on button HotNewItem"
...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_display_list_of_items_fixed_part_item_main_or_descendent_item/button_HotNewItem'))

WebUI.takeScreenshot(reportLocation + '/TC74/Step 4-Click on button HotNewItem.png')
...
WebUI.takeScreenshot(reportLocation + '/TC74/Step 5-Click on label itemAttributes StorageCapacity.png')
...
WebUI.takeScreenshot(reportLocation + '/TC74/Step 6-Click on label itemAttributes ColorOption.png')
...
WebUI.takeScreenshot(reportLocation + '/TC74/Step 7-Click on button quantityControl Increased.png')
...
WebUI.takeScreenshot(reportLocation + '/TC74/Step 8-Click on button quantityControl Buy.png')
...
WebUI.takeScreenshot(reportLocation + '/TC74/Step 9-Hover over link GoToCart.png')

"Step 10: Click on span navigationLinks (PageLink) -> Navigate to page 'display list of items:/{fixed page}'"
...
WebUI.takeScreenshot(reportLocation + '/TC74/Step 10-Click on span navigationLinks PageLink - Navigate to page display list of itemsfixed page.png')
...
WebUI.takeScreenshot(reportLocation + '/TC74/Step 11-Click on button IncreaseQuantity.png')
...
WebUI.takeScreenshot(reportLocation + '/TC74/Step 13-Click on button CompleteOrder - Navigate to page display single itemfixed pageitem id or slug.png')

"Step 14: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC74-Complete Order for New Apple Item with Quantity Adjustment_visual_checkpoint')
