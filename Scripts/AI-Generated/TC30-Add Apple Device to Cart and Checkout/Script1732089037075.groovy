...
WebUI.takeScreenshot(reportLocation + '/TC30/Step 2-Hover over item object2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC30/Step 4-Click on button addToCart AddToCart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC30/Step 5-Click on label colorStorageOptions Storage512GB.png')
...
WebUI.takeScreenshot(reportLocation + '/TC30/Step 6-Click on label colorStorageOptions Green.png')
...
WebUI.takeScreenshot(reportLocation + '/TC30/Step 7-Click on button Buy.png')
...
WebUI.takeScreenshot(reportLocation + '/TC30/Step 8-Click on link goToCart GoToCart3 - Navigate to page cart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC30/Step 9-Click on button ProceedToCheckout - Navigate to page checkoutpayment.png')
...
WebUI.takeScreenshot(reportLocation + '/TC30/Step 10-Click on button CompleteOrder - Navigate to page thank-you.png')

"Step 11: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC30-Add Apple Device to Cart and Checkout_visual_checkpoint')
