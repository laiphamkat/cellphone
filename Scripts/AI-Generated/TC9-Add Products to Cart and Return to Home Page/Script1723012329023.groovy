...
"Step 21: Subscribe to news via email and continue to shipping"

subscribeToNewsAndContinueToShipping.execute(data_path_0, Integer.valueOf(index_0))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC9-Add Products to Cart and Return to Home Page_visual_checkpoint')
