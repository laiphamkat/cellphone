...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 3-Click on link Apple - Navigate to page checkoutinfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 4-Hover over div CheckoutInfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 5-Click on input Email.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 6-Enter input value in input Email.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 7-Click on button ContinueToShipping - Navigate to page checkoutshipping-address.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 8-Hover over div CheckoutShippingAddress.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 9-Click on input FirstName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 10-Hover over div CheckoutShippingAddress2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 11-Enter input value in input FirstName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 12-Click on input LastName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 13-Hover over div CheckoutShippingAddress3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 14-Enter input value in input LastName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 15-Click on input Address.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 16-Hover over div CheckoutShippingAddress4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 17-Enter input value in input Address.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 18-Click on input ZipCode.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 19-Hover over div CheckoutShippingAddress5.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 20-Enter input value in input ZipCode.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 21-Click on input ShippingCity.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 22-Hover over div CheckoutShippingAddress6.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 23-Click on input State.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 24-Enter input value in input ShippingCity.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 25-Hover over div CheckoutShippingAddress7.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 26-Enter input value in input State.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 27-Click on input Phone.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 28-Enter input value in input Phone.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 29-Click on button ContinueToPayment - Navigate to page checkoutpayment.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 30-Click on button CompleteOrder - Navigate to page thank-you.png')

"Step 31: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC7-Complete Order with Detailed Shipping Information_visual_checkpoint')
