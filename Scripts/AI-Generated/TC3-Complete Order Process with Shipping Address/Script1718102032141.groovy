...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 2: Click on button 1.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 3: Click on label 2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 4: Hover over link 3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 5: Click on span 4 - Navigate to page cart.png')
...
"Step 7: Fill shipping address and proceed to payment"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC3-Complete Order Process with Shipping Address_visual_checkpoint')
