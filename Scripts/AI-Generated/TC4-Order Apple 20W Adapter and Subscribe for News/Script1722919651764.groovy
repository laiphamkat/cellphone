...
import katalon.common.subscribeForNewsAndContinueToShipping
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_category/link_categorySamsung'))
...
"Step 15: Subscribe for news updates and proceed to shipping"

subscribeForNewsAndContinueToShipping.execute(data_path_0, Integer.valueOf(index_0))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC4-Order Apple 20W Adapter and Subscribe for News_visual_checkpoint')
