...
"Step 4: Click on button applePhones (newIphone15Plus)"
...
WebUI.takeScreenshot(reportLocation + '/TC15/Step 4-Click on button applePhones newIphone15Plus.png')
...
"Step 6: Click on label storageOptions (pink)"
...
WebUI.takeScreenshot(reportLocation + '/TC15/Step 6-Click on label storageOptions pink.png')

"Step 7: Click on label storageOptions (1Tb)"
...
WebUI.takeScreenshot(reportLocation + '/TC15/Step 7-Click on label storageOptions 1Tb.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC15-Add and Remove Items from Cart_visual_checkpoint')
