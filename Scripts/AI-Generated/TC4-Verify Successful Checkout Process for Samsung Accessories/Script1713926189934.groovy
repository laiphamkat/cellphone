...
import katalon.common.inputShippingAddressAndContinueToPayment
...
"Step 4: Proceed to checkout and input shipping details"

WebUI.takeScreenshot()

proceedToCheckoutAndInputShippingDetails.execute(data_path_0, Integer.valueOf(index_0))

"Step 5: Input shipping address details and continue to payment"

WebUI.takeScreenshot()

inputShippingAddressAndContinueToPayment.execute(data_path_1, Integer.valueOf(index_1))

"Step 6: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC4-Verify Successful Checkout Process for Samsung Accessories_visual_checkpoint')
