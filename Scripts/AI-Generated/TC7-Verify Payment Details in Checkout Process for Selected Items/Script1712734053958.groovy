...
"Step 3: Proceed to checkout after selecting items"

WebUI.takeScreenshot()

proceedToCheckout.execute(data_path_0, Integer.valueOf(index_0))

"Step 4: Enter shipping details for payment"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC7-Verify Payment Details in Checkout Process for Selected Items_visual_checkpoint')
