...
WebUI.takeScreenshot(reportLocation + '/TC109/Step 2-Hover over item productCategories object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC109/Step 3-Click on link brandNames GooglePixel - Navigate to page category.png')

"Step 4: Click on link productModels (GooglePixel8) -> Navigate to page 'product/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC109/Step 4-Click on link productModels GooglePixel8 - Navigate to page product.png')

"Step 5: Click on label storageOptions (Storage512GB2)"
...
WebUI.takeScreenshot(reportLocation + '/TC109/Step 5-Click on label storageOptions Storage512GB2.png')

"Step 6: Click on label storageOptions (ColorBlack)"
...
WebUI.takeScreenshot(reportLocation + '/TC109/Step 6-Click on label storageOptions ColorBlack.png')

"Step 7: Click on button purchase (Buy2)"
...
WebUI.takeScreenshot(reportLocation + '/TC109/Step 7-Click on button purchase Buy2.png')

"Step 8: Click on link goToCartMultiple (GoToCart3) -> Navigate to page '/cart'"
...
WebUI.takeScreenshot(reportLocation + '/TC109/Step 8-Click on link goToCartMultiple GoToCart3 - Navigate to page cart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC109/Step 9-Click on button ProceedToCheckout - Navigate to page checkoutinfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC109/Step 10-Hover over div EmailSubscription.png')
...
WebUI.takeScreenshot(reportLocation + '/TC109/Step 11-Click on input Email.png')
...
WebUI.takeScreenshot(reportLocation + '/TC109/Step 12-Enter input value in input Email.png')
...
WebUI.takeScreenshot(reportLocation + '/TC109/Step 13-Click on button ContinueToShipping.png')
...
WebUI.takeScreenshot(reportLocation + '/TC109/Step 15-Click on button CompleteOrder - Navigate to page thank-you.png')

"Step 16: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC109-Complete Order Process with Email Subscription for Multiple Products_visual_checkpoint')
