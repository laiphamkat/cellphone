...
"Step 7: Proceed to checkout after entering email and shipping info"

WebUI.takeScreenshot()

proceedToCheckoutWithEmailAndShippingInfo.execute(data_path_0, Integer.valueOf(index_0))

"Step 8: Enter delivery and shipping address details for payment"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC13-Verify Successful Order Completion for Samsung Galaxy Z Fold4 Silicon Cover_visual_checkpoint')
