...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 2-Click on link Samsung - Navigate to page categorycategory.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 4-Click on button Buy.png')
