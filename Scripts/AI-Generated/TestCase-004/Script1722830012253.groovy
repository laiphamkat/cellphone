...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 2-Click on link apple - Navigate to page category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 3-Click on link goToCart - Navigate to page cart.png')
...
"Step 5: Click on button proceedToCheckout -> Navigate to page ''"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/cart?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_cart/button_proceedToCheckout'))

WebUI.takeScreenshot(reportLocation + '/TC4/Step 5-Click on button proceedToCheckout - Navigate to page .png')
