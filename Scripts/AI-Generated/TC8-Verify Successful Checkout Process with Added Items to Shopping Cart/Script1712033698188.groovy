...
"Step 11: Click on link ' Place an order' -> Navigate to page ''"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC8-Verify Successful Checkout Process with Added Items to Shopping Cart_visual_checkpoint')
