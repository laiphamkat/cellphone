...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 4-Click on label storageColorOption green.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC5-Purchase Item with Increased Storage and Verify Home Page_visual_checkpoint')
