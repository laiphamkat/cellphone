import katalon.common.inputEmailAndContinueToShipping
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 4-Click on link productApple20WusbcpowerAdapter - Navigate to page product.png')
...
"Step 8: Click on link productApple20WusbcpowerAdapter -> Navigate to page 'product/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/category/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_category/link_productApple20WusbcpowerAdapter', ['class': link_productApple20WusbcpowerAdapter_class, 'internalRoleLinkName': link_productApple20WusbcpowerAdapter_internalRoleLinkName]))

WebUI.takeScreenshot(reportLocation + '/TC9/Step 8-Click on link productApple20WusbcpowerAdapter - Navigate to page product.png')
...
"Step 21: Input email and proceed to shipping for notifications"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC9-Add Samsung Power Adapter and iPhone Case to Cart_visual_checkpoint')
