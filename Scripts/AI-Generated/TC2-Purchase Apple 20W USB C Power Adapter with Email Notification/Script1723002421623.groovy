...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 4-Click on link productApple20WusbcpowerAdapter - Navigate to page product.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC2-Purchase Apple 20W USB C Power Adapter with Email Notification_visual_checkpoint')
