...
"Step 4: Select items and place an order"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC12-Verify Successful Checkout and Order Completion with Payment Method_visual_checkpoint')
