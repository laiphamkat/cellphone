...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_category_chekhly_na_iphone/link_sortOptions_1"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_category_chekhly_na_iphone/link_sortOptions_1', ['link_sortOptions_nthChild': link_sortOptions_nthChild, 'link_sortOptions_internalRoleLinkName': link_sortOptions_internalRoleLinkName]))

WebUI.takeScreenshot(reportLocation + '/TC11/Step 4-Click on link sortOptions byPrice.png')
...
WebUI.takeScreenshot(reportLocation + '/TC11/Step 5-Click on button addToCart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC11/Step 6-Click on label iphoneModels iphone15Plus.png')
...
WebUI.takeScreenshot(reportLocation + '/TC11/Step 7-Click on label iphoneModels cypress.png')
...
WebUI.takeScreenshot(reportLocation + '/TC11/Step 13-Click on button quantityAdjustment increased.png')
...
WebUI.takeScreenshot(reportLocation + '/TC11/Step 14-Click on button quantityAdjustment increased.png')
...
WebUI.takeScreenshot(reportLocation + '/TC11/Step 16-Hover over div email.png')
...
"Step 20: Fill in shipping information and continue to payment"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC11-Add iPhone and Samsung Products to Cart_visual_checkpoint')
