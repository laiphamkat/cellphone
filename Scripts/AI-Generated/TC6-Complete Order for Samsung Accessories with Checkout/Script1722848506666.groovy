...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 5-Click on link byTitle.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 6-Click on link categorySamsung.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 7-Click on link productApple20Wusbadapter - Navigate to page product.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 8-Click on label object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 9-Click on label object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 10-Click on button buy.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 11-Click on link placeAnOrder - Navigate to page cart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 12-Click on button increased.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 13-Click on link goToCart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 14-Click on button proceedToCheckout - Navigate to page checkoutinfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 15-Hover over div emailMeWithNews.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 16-Click on input email.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 17-Enter input value in input email.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 18-Click on button continueToShipping.png')

"Step 19: Fill in shipping address details and proceed to payment"
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 20-Click on button completeOrder - Navigate to page .png')

"Step 21: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC6-Complete Order for Samsung Accessories with Checkout_visual_checkpoint')
