...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 3: Click on link categoryChekhlyNaIphone - Navigate to page category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 4: Click on link goToCart - Navigate to page cart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 7: Click on button proceedToCheckout - Navigate to page checkoutpayment.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 8: Click on button completeOrder - Navigate to page thank-you.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 9: Hover over item accessories.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 10: Click on link apple - Navigate to page category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 11: Hover over item accessories.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 12: Click on link apple - Navigate to page .png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 13: Click on button addToCartSamsungGalaxyS23.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 14: Click on label 256Gb.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 15: Click on label 256Gb.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 16: Click on button buy2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 17: Click on link goToCart - Navigate to page cart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 18: Click on button increased.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 19: Hover over item phone.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 20: Click on link apple2 - Navigate to page category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 21: Click on button newiPhone15Plus.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 22: Click on label 1Tb.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 23: Click on label 1Tb.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 24: Click on button buy2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 25: Click on link goToCart - Navigate to page cart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 26: Click on button increased.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 27: Click on button proceedToCheckout - Navigate to page checkoutinfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 28: Click on link backToTheCart - Navigate to page cart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 29: Hover over item phone.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 30: Click on link apple2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 31: Click on link apple2 - Navigate to page category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 32: Click on button productsItemInStock.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 33: Click on button productsItemInStock.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 34: Click on label 1Tb.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 35: Click on label 1Tb.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 36: Click on label 1Tb.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 37: Click on label 1Tb.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 39: Click on button object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 40: Click on link goToCart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 41: Click on link goToCart - Navigate to page cart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 42: Click on button increased.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 43: Click on button increased.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 44: Click on button proceedToCheckout.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 45: Click on button proceedToCheckout - Navigate to page checkoutinfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 46: Hover over div emailMeWithNews.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 47: Click on input email.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 48: Enter input value in input email.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 49: Click on button continueToShipping - Navigate to page .png')

"Step 50: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC16-Extensive Shopping and Checkout Process_visual_checkpoint')
