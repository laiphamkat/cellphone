...
"Step 6: Proceed to checkout and input shipping details"

WebUI.takeScreenshot()

proceedToCheckoutAndInputShippingDetails.execute(data_path_0, Integer.valueOf(index_0))

"Step 7: Input shipping address details and continue to payment"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC2-Verify Successful Checkout Process for Phone Purchase_visual_checkpoint')
