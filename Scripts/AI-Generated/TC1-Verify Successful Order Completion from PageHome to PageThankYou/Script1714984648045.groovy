...
WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_category_chekhly_na_iphone/link_1'), 20, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/category/chekhly-na-iphone?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_category_chekhly_na_iphone/link_1'))

"Step 6: Proceed to checkout, fill shipping details, and complete order"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC1-Verify Successful Order Completion from PageHome to PageThankYou_visual_checkpoint')
