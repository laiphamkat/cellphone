...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 3-Click on link Accessories - Navigate to page category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 5-Click on button Sale20WUSBAdapter.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 6-Click on link PlaceAnOrder - Navigate to page cart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 9-Hover over div CheckoutInfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 10-Click on input Email.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 11-Enter input value in input Email.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 12-Click on button ContinueToShipping - Navigate to page .png')

"Step 13: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC4-Place Order for Accessories and Return to Home_visual_checkpoint')
