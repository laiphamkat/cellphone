...
import katalon.common.setPriceRangeForAccessoriesCategoryAndSearch
...
setPriceRangeForAccessoriesCategoryAndSearch.execute(data_path_0, Integer.valueOf(index_0))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC9-Verify Payment Confirmation for Checkout Process_visual_checkpoint')
