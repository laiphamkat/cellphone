...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 3-Click on link GooglePixel - Navigate to page category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 5-Hover over link Cart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 8-Click on button CompleteOrder - Navigate to page thank-you.png')

"Step 9: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC7-Add Google Pixel to Cart and Complete Order_visual_checkpoint')
