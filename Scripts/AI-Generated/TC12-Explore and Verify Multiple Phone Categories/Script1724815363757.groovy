...
"Step 7: Click on button samsungAccessories (samsungGalaxyZfold4)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/category/power-and-cables?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_category_power_and_cables/button_samsungAccessories"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_category_power_and_cables/button_samsungAccessories', ['button_samsungAccessories_class': button_samsungAccessories_class, 'button_samsungAccessories_internalHasText': button_samsungAccessories_internalHasText]))

WebUI.takeScreenshot(reportLocation + '/TC12/Step 7-Click on button samsungAccessories samsungGalaxyZfold4.png')

"Step 8: Click on button samsungAccessories (samsungGalaxyS23Ultra)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/category/power-and-cables?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_category_power_and_cables/button_samsungAccessories"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_category_power_and_cables/button_samsungAccessories', ['button_samsungAccessories_class': button_samsungAccessories_class_1, 'button_samsungAccessories_internalHasText': button_samsungAccessories_internalHasText_1]))

WebUI.takeScreenshot(reportLocation + '/TC12/Step 8-Click on button samsungAccessories samsungGalaxyS23Ultra.png')
...
"Step 15: Click on button samsungPhones (samsungGalaxyZfold5)"
...
WebUI.takeScreenshot(reportLocation + '/TC12/Step 15-Click on button samsungPhones samsungGalaxyZfold5.png')
...
"Step 29: Click on button samsungPhones (hotSamsungGalaxyS23)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/category/samsung?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_category_samsung/button_samsungPhones"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_category_samsung/button_samsungPhones', ['button_samsungPhones_class': button_samsungPhones_class_1, 'button_samsungPhones_internalHasText': button_samsungPhones_internalHasText_1]))

WebUI.takeScreenshot(reportLocation + '/TC12/Step 29-Click on button samsungPhones hotSamsungGalaxyS23.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC12-Explore and Verify Multiple Phone Categories_visual_checkpoint')
