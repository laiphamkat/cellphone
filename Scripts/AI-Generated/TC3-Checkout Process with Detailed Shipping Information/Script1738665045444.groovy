...
"Step 3: Click on link brand (Apple2)"
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 3-Click on link brand Apple2.png')
...
"Step 5: Click on link PlaceAnOrder -> Navigate to page 'cart#cart'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'category/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_category/link_PlaceAnOrder'))

WebUI.takeScreenshot(reportLocation + '/TC3/Step 5-Click on link PlaceAnOrder - Navigate to page cartcart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 7-Hover over div Object.png')
...
"Step 20: Hover over div Object4"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.mouseOver(findTestObject('AI-Generated/Page_checkout/div_Object4'))

WebUI.takeScreenshot(reportLocation + '/TC3/Step 20-Hover over div Object4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 23-Hover over div Object5.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC3-Checkout Process with Detailed Shipping Information_visual_checkpoint')
