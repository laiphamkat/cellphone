...
"Step 4: Proceed to checkout after providing email and marketing info"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC6-Verify Payment Process on Checkout Page After Providing Shipping Details_visual_checkpoint')
