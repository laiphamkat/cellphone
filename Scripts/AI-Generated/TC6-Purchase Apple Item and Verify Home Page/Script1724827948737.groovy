...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 3-Click on link apple2 - Navigate to page categoryapple.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 5-Click on label storageColorOption 512Gb.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 6-Click on label storageColorOption green.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 7-Click on button buy.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 9-Click on button proceedToCheckout - Navigate to page checkoutpayment.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 10-Click on button completeOrder - Navigate to page .png')

"Step 11: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC6-Purchase Apple Item and Verify Home Page_visual_checkpoint')
