import katalon.common.buyItemsAndProceedToCart
...
buyItemsAndProceedToCart.execute()
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC13-Verify Successful Payment and Order Completion for iPhone 15 Purchase_visual_checkpoint')
