...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 4-Hover over item item.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 5-Click on link samsung - Navigate to page category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 6-Click on link samsungGalaxyZfold5 - Navigate to page product.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 7-Click on label 512Gb.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 8-Click on label blue.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 10-Hover over link goToCart.png')

"Step 11: Click on span shoppingCart -> Navigate to page '/cart'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/product/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_product/span_shoppingCart'))

WebUI.takeScreenshot(reportLocation + '/TC4/Step 11-Click on span shoppingCart - Navigate to page cart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 12-Click on button proceedToCheckout - Navigate to page checkoutpayment.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 13-Click on button completeOrder - Navigate to page thank-you.png')

"Step 14: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC4-Complete Order for Samsung Galaxy Z Fold 5 in Blue Color_visual_checkpoint')
