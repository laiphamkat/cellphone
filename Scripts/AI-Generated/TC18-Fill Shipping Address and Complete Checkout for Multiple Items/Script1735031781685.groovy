...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 3-Click on button purchaseActions Increased.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 4-Click on button purchaseActions Increased.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 5-Click on button purchaseActions Increased.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 6-Click on button purchaseActions Increased.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 8-Click on label storageOptions 256GB.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 9-Click on label storageOptions Pink.png')
...
"Step 17: Proceed to checkout after entering email and continue to shipping."
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC18-Fill Shipping Address and Complete Checkout for Multiple Items_visual_checkpoint')
