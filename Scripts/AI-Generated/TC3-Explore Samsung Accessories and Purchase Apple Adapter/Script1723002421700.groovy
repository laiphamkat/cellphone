...
"Step 7: Click on link productApple20WusbcpowerAdapter -> Navigate to page 'product/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 7-Click on link productApple20WusbcpowerAdapter - Navigate to page product.png')
...
"Step 10: Click on link productApple20WusbcpowerAdapter -> Navigate to page 'product/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/category/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_category/link_productApple20WusbcpowerAdapter', ['class': link_productApple20WusbcpowerAdapter_class, 'internalRoleLinkName': link_productApple20WusbcpowerAdapter_internalRoleLinkName]))

WebUI.takeScreenshot(reportLocation + '/TC3/Step 10-Click on link productApple20WusbcpowerAdapter - Navigate to page product.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC3-Explore Samsung Accessories and Purchase Apple Adapter_visual_checkpoint')
