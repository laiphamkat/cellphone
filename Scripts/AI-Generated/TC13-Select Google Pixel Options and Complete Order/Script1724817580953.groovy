...
"Step 8: Select options and proceed to checkout from cart"

selectOptionsAndProceedToCheckout.execute(data_path_0, Integer.valueOf(index_0))

"Step 9: Fill shipping information and continue to payment"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC13-Select Google Pixel Options and Complete Order_visual_checkpoint')
