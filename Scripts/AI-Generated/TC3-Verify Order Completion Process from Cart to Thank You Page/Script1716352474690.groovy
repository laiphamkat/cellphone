...
"Step 7: Fill shipping address and complete order"

fillShippingAddressAndCompleteOrder.execute(data_path_0, Integer.valueOf(index_0))

"Step 8: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC3-Verify Order Completion Process from Cart to Thank You Page_visual_checkpoint')
