...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 13-Click on input LastName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 15-Enter input value in input LastName2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 16-Click on input Address.png')
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 18-Enter input value in input Address2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 19-Click on input ZipCode.png')
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 21-Enter input value in input ZipCode2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 22-Click on input City.png')
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 24-Enter input value in input City2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 25-Click on input State.png')
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 27-Enter input value in input State2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 28-Click on input Phone.png')
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 29-Enter input value in input Phone2.png')
