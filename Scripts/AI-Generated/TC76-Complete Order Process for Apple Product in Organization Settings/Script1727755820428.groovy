...
WebUI.takeScreenshot(reportLocation + '/TC76/Step 4-Hover over item object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC76/Step 5-Click on link Apple - Navigate to page category.png')

"Step 6: Click on label colorStorageOption (512GB)"
...
WebUI.takeScreenshot(reportLocation + '/TC76/Step 6-Click on label colorStorageOption 512GB.png')

"Step 7: Click on label colorStorageOption (Color)"
...
WebUI.takeScreenshot(reportLocation + '/TC76/Step 7-Click on label colorStorageOption Color.png')

"Step 8: Hover over link Cart -> Navigate to page 'checkout/payment'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/category/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.mouseOver(findTestObject('AI-Generated/Page_category/link_Cart'))

WebUI.takeScreenshot(reportLocation + '/TC76/Step 8-Hover over link Cart - Navigate to page checkoutpayment.png')
...
WebUI.takeScreenshot(reportLocation + '/TC76/Step 9-Click on button CompleteOrder - Navigate to page thank-you.png')

"Step 10: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC76-Complete Order Process for Apple Product in Organization Settings_visual_checkpoint')
