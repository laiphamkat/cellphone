...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 7-Click on link productApple20WusbcpowerAdapter - Navigate to page product.png')
...
"Step 15: Input email and proceed to shipping for notifications"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC4-Buy Apple Adapter with Email Notification and Checkout_visual_checkpoint')
