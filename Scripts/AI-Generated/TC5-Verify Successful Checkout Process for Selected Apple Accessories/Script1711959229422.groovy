...
import katalon.common.buyAndProceedToCheckout
...
buyAndProceedToCheckout.execute(null, Integer.parseInt(1))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC5-Verify Successful Checkout Process for Selected Apple Accessories_visual_checkpoint')
