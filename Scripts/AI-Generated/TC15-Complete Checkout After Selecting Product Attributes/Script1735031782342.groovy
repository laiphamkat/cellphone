...
WebUI.takeScreenshot(reportLocation + '/TC15/Step 3-Click on link productBrands Apple2 - Navigate to page category.png')
...
"Step 5: Click on label productAttributes (StorageCapacity2)"
...
WebUI.takeScreenshot(reportLocation + '/TC15/Step 5-Click on label productAttributes StorageCapacity2.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC15-Complete Checkout After Selecting Product Attributes_visual_checkpoint')
