...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 2-Click on link categoryChekhlyNaIphone - Navigate to page category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 3-Click on button sale20WusbpowerAdapter - Navigate to page .png')

"Step 4: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC2-Check Sale Item for iPhone Accessories on Home Page_visual_checkpoint')
