import katalon.common.selectPhoneCategoryAndProceedToCheckout
...
selectPhoneCategoryAndProceedToCheckout.execute(null, Integer.parseInt(1))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC16-Verify Successful Checkout Process for Selected Phone_visual_checkpoint')
