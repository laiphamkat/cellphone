...
"Step 9: Buy selected items and place an order"

WebUI.takeScreenshot()

buyItemsAndPlaceOrder.execute()

"Step 10: Proceed to checkout after providing email and marketing info"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC3-Verify Shipping Address Page After Selecting Items and Proceeding to Checkout_visual_checkpoint')
