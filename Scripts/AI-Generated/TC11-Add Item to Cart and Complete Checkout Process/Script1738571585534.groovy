...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_category/link_brand', ['link_brand_nthChild': link_brand_nthChild, 'link_brand_internalRoleLinkName': link_brand_internalRoleLinkName, 'category_id': category_id]))

WebUI.takeScreenshot(reportLocation + '/TC11/Step 3-Click on link brand Apple.png')
...
WebUI.takeScreenshot(reportLocation + '/TC11/Step 4-Click on button addToCart AddToCart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC11/Step 5-Click on link PlaceAnOrder.png')
...
WebUI.takeScreenshot(reportLocation + '/TC11/Step 7-Hover over div object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC11/Step 8-Click on input FirstName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC11/Step 9-Hover over div object2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC11/Step 10-Enter input value in input FirstName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC11/Step 11-Click on input LastName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC11/Step 12-Hover over div object3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC11/Step 13-Enter input value in input LastName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC11/Step 14-Click on input Address.png')
...
WebUI.takeScreenshot(reportLocation + '/TC11/Step 15-Enter input value in input Address.png')
...
WebUI.takeScreenshot(reportLocation + '/TC11/Step 16-Hover over div object4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC11/Step 17-Enter input value in input ZipCode.png')
...
WebUI.takeScreenshot(reportLocation + '/TC11/Step 18-Click on input City.png')
...
WebUI.takeScreenshot(reportLocation + '/TC11/Step 19-Hover over div object5.png')
...
WebUI.takeScreenshot(reportLocation + '/TC11/Step 20-Enter input value in input City.png')
...
WebUI.takeScreenshot(reportLocation + '/TC11/Step 21-Click on input State.png')
...
WebUI.takeScreenshot(reportLocation + '/TC11/Step 22-Hover over div object6.png')
...
WebUI.takeScreenshot(reportLocation + '/TC11/Step 23-Enter input value in input State.png')
...
WebUI.takeScreenshot(reportLocation + '/TC11/Step 24-Click on input Phone.png')
...
WebUI.takeScreenshot(reportLocation + '/TC11/Step 25-Enter input value in input Phone.png')
...
WebUI.takeScreenshot(reportLocation + '/TC11/Step 26-Click on button ContinueToPayment - Navigate to page checkoutcheckoutpayment.png')
...
WebUI.takeScreenshot(reportLocation + '/TC11/Step 27-Click on button CompleteOrder - Navigate to page thank youthank-you.png')

"Step 28: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC11-Add Item to Cart and Complete Checkout Process_visual_checkpoint')
