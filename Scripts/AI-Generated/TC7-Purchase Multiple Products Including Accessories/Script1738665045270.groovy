...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 3-Click on link productDetails SamsungGalaxyS23UltraSmartviewCases - Navigate to page productproduct.png')
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_category/link_productDetails"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_category/link_productDetails', ['link_productDetails_class': link_productDetails_class_1, 'link_productDetails_internalRoleLinkName': link_productDetails_internalRoleLinkName_1, 'product_id': product_id_1]))

WebUI.takeScreenshot(reportLocation + '/TC7/Step 7-Click on link productDetails SamsungGalaxyS23UltraSmartviewCases.png')

"Step 8: Select Apple product and complete the purchase process"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC7-Purchase Multiple Products Including Accessories_visual_checkpoint')
