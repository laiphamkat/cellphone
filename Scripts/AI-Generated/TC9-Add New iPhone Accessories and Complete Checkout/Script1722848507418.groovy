...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 19-Click on button proceedToCheckout - Navigate to page checkoutinfo.png')
...
"Step 21: Complete email subscription and fill shipping details"

subscribeEmailAndFillShippingDetails.execute(data_path_0, Integer.valueOf(index_0))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC9-Add New iPhone Accessories and Complete Checkout_visual_checkpoint')
