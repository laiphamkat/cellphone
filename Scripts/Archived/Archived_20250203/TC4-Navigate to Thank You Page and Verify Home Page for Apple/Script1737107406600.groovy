...
WebUI.mouseOver(findTestObject('Archived/Archived_20250203/Page_thank_you/item_object'))
...
WebUI.enhancedClick(findTestObject('Archived/Archived_20250203/Page_thank_you/link_Apple'))

WebUI.takeScreenshot(reportLocation + '/TC4/Step 3-Click on link Apple - Navigate to page .png')

"Step 4: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC4-Navigate to Thank You Page and Verify Home Page for Apple_visual_checkpoint')
