...
WebUI.takeScreenshot(reportLocation + '/TC12/Step 2-Hover over item object3.png')

"Step 3: Click on link PhoneCategory -> Navigate to page 'category/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('Archived/Archived_20241226/Page_home/link_PhoneCategory'))

WebUI.takeScreenshot(reportLocation + '/TC12/Step 3-Click on link PhoneCategory - Navigate to page category.png')

"Step 4: Click on link productDetails (iPhone15) -> Navigate to page 'product/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC12/Step 4-Click on link productDetails iPhone15 - Navigate to page product.png')

"Step 5: Click on label storageColorOptions (colorStorageOptions)"
...
WebUI.takeScreenshot(reportLocation + '/TC12/Step 5-Click on label storageColorOptions colorStorageOptions.png')

"Step 6: Click on label storageColorOptions (colorStorageOptions2)"
...
WebUI.takeScreenshot(reportLocation + '/TC12/Step 6-Click on label storageColorOptions colorStorageOptions2.png')

"Step 7: Click on button Buy"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/product/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('Archived/Archived_20241226/Page_product/button_Buy'))
...
WebUI.enhancedClick(findTestObject('Archived/Archived_20241226/Page_product/link_PlaceOrder'))

WebUI.takeScreenshot(reportLocation + '/TC12/Step 8-Click on link PlaceOrder - Navigate to page cart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC12/Step 9-Click on button ProceedToCheckout2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC12/Step 11-Click on button CompleteOrder - Navigate to page thank-you.png')

"Step 12: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC12-Purchase Phone and Complete Checkout Process_visual_checkpoint')
